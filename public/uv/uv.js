...
!function (global) {
    ...
    function newContext(e) {
        ...
        function n(e, n, i) {
            var o, r, s, a, u, l, c, h, p, d, f, g, v = n && n.split("/"), m = S.map, y = m && m["*"];
            if (e && (e = e.split("/"), c = e.length - 1, S.nodeIdCompat && jsSuffixRegExp.test(e[c]) && (e[c] = e[c].replace(jsSuffixRegExp, "")), "." === e[0].charAt(0) && v && (g = v.slice(0, v.length - 1), e = g.concat(e)), t(e), e = e.join("/")), i && m && (v || y)) {
                s = e.split("/");
                e:for (a = s.length; a > 0; a -= 1) {
                    if (l = s.slice(0, a).join("/"), v) for (u = v.length; u > 0; u -= 1) if (r = getOwn(m, v.slice(0, u).join("/")), r && (r = getOwn(r, l))) {
                        h = r, p = a;
                        break e
                    }
        ...
        function s(e, t, i, o) {
            var s, a, u, l, c = null, h = t ? t.name : null, p = e, d = !0, f = "";
            return e || (d = !1, e = "_@r" + (R += 1)), l = r(e), c = l[0], e = l[1], c && (c = n(c, h, o), a = getOwn(O, c)), e && (c ? f = a && a.normalize ? a.normalize(e, function (e) {
                return n(e, h, o)
            }) : -1 === e.indexOf("!") ? n(e, h, o) : e : (f = n(e, h, o), l = r(f), c = l[0], f = l[1], i = !0, s = b.nameToUrl(f))), u = !c || a || i ? "" : "_unnormalized" + (P += 1), {
                prefix: c,
                name: f,
                parentMap: t,
                unnormalized: !!u,
        ...
        function a(e) {
            var t = e.id, n = getOwn(x, t);
            return n || (n = x[t] = new b.Module(e)), n
        }

        function u(e, t, n) {
            var i = e.id, o = getOwn(x, i);
            !hasProp(O, i) || o && !o.defineEmitComplete ? (o = a(e), o.error && "error" === t ? n(o.error) : o.on(t, n)) : "defined" === t && n(O[i])
        }
        ...
        function p(e, t, n) {
            ...
            e.error ? e.emit("error", e.error) : (t[i] = !0, each(e.depMaps, function (i, o) {
                var r = i.id, s = getOwn(x, r);
                !s || e.depMatched[o] || n[r] || (getOwn(t, r) ? (e.defineDep(o, O[r]), e.check()) : p(s, t, n))
            }), n[i] = !0)
        }

        function d() {
            var e, t, n = 1e3 * S.waitSeconds, r = n && b.startTime + n < (new Date).getTime(), s = [], a = [], u = !1,
                c = !0;
            if (!y) {
                if (y = !0, eachProp($, function (e) {
                    var n = e.map, l = n.id;
                    if (e.enabled && (n.isDefine || a.push(e), !e.error)) if (!e.inited && r) o(l) ? (t = !0, u = !0) : (s.push(l), i(l)); else if (!e.inited && e.fetched && n.isDefine && (u = !0, !n.prefix)) return c = !1
                }), r && s.length) return e = makeError("timeout", "Load timeout for modules: " + s, null, s), e.contextName = b.contextName, l(e);
                c && each(a, function (e) {
                    p(e, {}, {})
        ...
        function m() {
            var e;
            for (c(); T.length;) {
                if (e = T.shift(), null === e[0]) return l(makeError("mismatch", "Mismatched anonymous define() module: " + e[e.length - 1]));
                f(e)
            }
            b.defQueueMap = {}
        }

        var y, E, b, _, w, S = {waitSeconds: 7, baseUrl: "./", paths: {}, bundles: {}, pkgs: {}, shim: {}, config: {}},
            x = {}, $ = {}, I = {}, T = [], O = {}, A = {}, C = {}, R = 1, P = 1;
        return _ = {
            require: function (e) {
            ...
            this.events = getOwn(I, e.id) || {}, this.map = e, this.shim = getOwn(S.shim, e.id), this.depExports = [], this.depMaps = [], this.depMatched = [], this.pluginMaps = {}, this.depCount = 0
        }, E.prototype = {
            init: function (e, t, n, i) {
                ...
                if (this.enabled && !this.enabling) {
                    var e, t, n = this.map.id, i = this.depExports, o = this.exports, r = this.factory;
                    if (this.inited) {
                        if (this.error) this.emit("error", this.error); else if (!this.defining) {
                            if (this.defining = !0, this.depCount < 1 && !this.defined) {
                                ...
                                if (this.exports = o, this.map.isDefine && !this.ignore && (O[n] = o, req.onResourceLoad)) {
                                    var a = [];
                ...
                this.depMaps.push(i), u(i, "defined", bind(this, function (i) {
                    var o, r, c, p = getOwn(C, this.map.id), d = this.map.name,
                        f = this.map.parentMap ? this.map.parentMap.name : null,
                        g = b.makeRequire(e.parentMap, {enableBuildCallback: !0});
                    ...
                    })), c = getOwn(x, r.id), void (c && (this.depMaps.push(r), this.events.error && c.on("error", bind(this, function (e) {
                        this.emit("error", e)
                    })), c.enable()))) : p ? (this.map.url = b.nameToUrl(p), void this.load()) : (o = bind(this, function (e) {
                        this.init([], function () {
                            return e
                        }, null, {enabled: !0})
                    }), o.error = bind(this, function (e) {
                        this.inited = !0, this.error = e, e.requireModules = [t], eachProp(x, function (e) {
                            0 === e.map.id.indexOf(t + "_unnormalized") && h(e.map.id)
                        }), l(e)
                    }), o.fromText = bind(this, function (n, i) {
                        var r = e.name, u = s(r), c = useInteractive;
                        i && (n = i), c && (useInteractive = !1), a(u), hasProp(S.config, t) && (S.config[r] = S.config[t]);
                        try {
                            req.exec(n)
                        } catch (h) {
                            return l(makeError("fromtexteval", "fromText eval for " + t + " failed: " + h, h, [t]))
                        }
                        c && (useInteractive = !0), this.depMaps.push(u), b.completeLoad(r), g([r], o)
                    }), void i.load(e.name, g, o, S))
                })), b.enable(i, this), this.pluginMaps[i.id] = i
            }, enable: function () {
                $[this.map.id] = this, this.enabled = !0, this.enabling = !0, each(this.depMaps, bind(this, function (e, t) {
                    var n, i, o;
                    if ("string" == typeof e) {
                    ...
                    n = e.id, i = x[n], hasProp(_, n) || !i || i.enabled || b.enable(e, this)
            ...
            configure: function (e) {
                ...
                var n = S.shim, i = {paths: !0, bundles: !0, config: !0, map: !0};
                eachProp(e, function (e, t) {
                    ...
                    isArray(e) && (e = {deps: e}), !e.exports && !e.init || e.exportsFn || (e.exportsFn = b.makeShimExports(e)), n[t] = e
                }), S.shim = n), e.packages && each(e.packages, function (e) {
                    var t, n;
                    e = "string" == typeof e ? {name: e} : e, n = e.name, t = e.location, t && (S.paths[n] = e.location), S.pkgs[n] = e.name + "/" + (e.main || "main").replace(currDirRegExp, "").replace(jsSuffixRegExp, "")
            ...
            makeRequire: function (t, o) {
                function r(n, i, u) {
                    var c, h, p;
                    return o.enableBuildCallback && i && isFunction(i) && (i.__requireJsBuild = !0), "string" == typeof n ? isFunction(i) ? l(makeError("requireargs", "Invalid require call"), u) : t && hasProp(_, n) ? _[n](x[t.id]) : req.get ? req.get(b, n, t, r) : (h = s(n, t, !1, !0), c = h.id, hasProp(O, c) ? O[c] : l(makeError("notloaded", 'Module name "' + c + '" has not been loaded yet for context: ' + e + (t ? "" : ". Use require([])")))) : (m(), b.nextTick(function () {
                        m(), p = a(s(null, t)), p.skipMap = o.skipMap, p.init(n, i, u, {enabled: !0}), d()
                    }), r)
                }

                return o = o || {}, mixin(r, {
                    isBrowser: isBrowser, toUrl: function (e) {
                        var i, o = e.lastIndexOf("."), r = e.split("/")[0], s = "." === r || ".." === r;
                        return -1 !== o && (!s || o > 1) && (i = e.substring(o, e.length), e = e.substring(0, o)), b.nameToUrl(n(e, t && t.id, !0), i, !0)
                    }, defined: function (e) {
                    ...
                    c();
                    var n = s(e, t, !0), o = getOwn(x, e);
                    o.undefed = !0, i(e), delete O[e], delete A[n.url], delete I[e], eachReverse(T, function (t, n) {
                        t[0] === e && T.splice(n, 1)
                    }), delete b.defQueueMap[e], o && (o.events.defined && (I[e] = o.events), h(e))
                }), r
            },
            enable: function (e) {
                var t = getOwn(x, e.id);
            ...
            completeLoad: function (e) {
                var t, n, i, r = getOwn(S.shim, e) || {}, s = r.exports;
                for (c(); T.length;) {
                ...
                if (b.defQueueMap = {}, i = getOwn(x, e), !t && !hasProp(O, e) && i && !i.inited) {
                    if (!(!S.enforceDefine || s && getGlobal(s))) return o(e) ? void 0 : l(makeError("nodefine", "No define call for " + e, null, [e]));
                    f([e, r.deps || [], r.exportsFn])
                }
                d()
            },
            nameToUrl: function (e, t, n) {
                var i, o, r, s, a, u, l, c = getOwn(S.pkgs, e);
                if (c && (e = c), l = getOwn(C, e)) return b.nameToUrl(l, t, n);
                if (req.jsExtRegExp.test(e)) a = e + (t || ""); else {
                    for (i = S.paths, o = e.split("/"), r = o.length; r > 0; r -= 1) if (s = o.slice(0, r).join("/"), u = getOwn(i, s)) {
                        isArray(u) && (u = u[0]), o.splice(0, r, u);
                        break
                    }
                    a = o.join("/"), a += t || (/^data\:|^blob\:|\?/.test(a) || n ? "" : ".js"), a = ("/" === a.charAt(0) || a.match(/^[\w\+\.\-]+:/) ? "" : S.baseUrl) + a
                }
    ...
    var req, s, head, baseElement, dataMain, src, interactiveScript, currentlyAddingScript, mainScript, subPath,
        version = "2.2.0", commentRegExp = /(\/\*([\s\S]*?)\*\/|([^:]|^)\/\/(.*)$)/gm,
    ...
    if ("undefined" == typeof define) {
        ...
        "undefined" == typeof require || isFunction(require) || (cfg = require, require = void 0), req = requirejs = function (e, t, n, i) {
            ...
            if (isWebWorker) try {
                setTimeout(function () {
                }, 0), importScripts(n), e.completeLoad(t)
            } catch (r) {
    ...
    return e.ajaxTransport("* text html xml json", function (o, r, s) {
        if (o.crossDomain && o.async && n.test(o.type) && t.test(o.url) && i.test(o.url)) {
            ...
            return {
                send: function (t, n) {
                    var i = "", s = (r.dataType || "").toLowerCase();
                    a = new XDomainRequest, /^\d+$/.test(r.timeout) && (a.timeout = r.timeout), a.ontimeout = function () {
                        ...
                        var t = "Content-Length: " + a.responseText.length + "\r\nContent-Type: " + a.contentType,
                            i = {code: 200, message: "success"}, o = {text: a.responseText};
                        try {
                            if ("html" === s || /text\/html/i.test(a.contentType)) o.html = a.responseText; else if ("json" === s || "text" !== s && /\/json/i.test(a.contentType)) try {
    ...
    function r() {
        l.input = function (n) {
            for (var i = 0, o = n.length; o > i; i++) E[n[i]] = n[i] in g;
    ...
    var s, a, u = "2.8.3", l = {}, c = !0, h = t.documentElement, p = "modernizr", d = t.createElement(p), f = d.style,
        g = t.createElement("input"), v = ":)", m = ({}.toString, {}), y = {}, E = {}, b = [], _ = b.slice,
        w = {}.hasOwnProperty;
    a = o(w, "undefined") || o(w.call, "undefined") ? function (e, t) {
        ...
        var n = _.call(arguments, 1), i = function () {
            if (this instanceof i) {
                ...
                var r = new o, s = t.apply(r, n.concat(_.call(arguments)));
    ...
    for (var S in m) a(m, S) && (s = S.toLowerCase(), l[s] = m[S](), b.push((l[s] ? "" : "no-") + s));
    return l.input || r(), l.addTest = function (e, t) {
        if ("object" == typeof e) for (var i in e) a(e, i) && l.addTest(i, e[i]); else {
            if (e = e.toLowerCase(), l[e] !== n) return l;
            t = "function" == typeof t ? t() : t, "undefined" != typeof c && c && (h.className += " " + (t ? "" : "no-") + e), l[e] = t
        }
        return l
    }, i(""), d = g = null, l._version = u, h.className = h.className.replace(/(^|\s)no-js(\s|$)/, "$1$2") + (c ? " js " + b.join(" ") : ""), l
    ...
    function u(e, n, i, o, r, u, l) {
        function c(t) {
            if (!d && s(h.readyState) && (E.r = d = 1, !y && a(), h.onload = h.onreadystatechange = null, t)) {
                "img" != e && f(function () {
                    _.removeChild(h)
                }, 50);
        ...
        var l = l || p.errorTimeout, h = t.createElement(e), d = 0, v = 0, E = {t: i, s: n, e: r, a: u, x: l};
        1 === I[n] && (v = 1, I[n] = []), "object" == e ? h.data = n : (h.src = n, h.type = e), h.width = h.height = "0", h.onerror = h.onload = h.onreadystatechange = function () {
            c.call(this, v)
        }, m.splice(o, 0, E), "img" != e && (v || 2 === I[n] ? (_.insertBefore(h, b ? null : g), f(c, l)) : I[n].push(h))
    }

    function l(e, t, n, i, r) {
        return y = 0, t = t || "j", o(e) ? u("c" == t ? S : w, e, t, this.i++, n, i, r) : (m.splice(this.i++, 0, e), 1 == m.length && a()), this
    }
    ...
    var h, p, d = t.documentElement, f = e.setTimeout, g = t.getElementsByTagName("script")[0], v = {}.toString, m = [],
        y = 0, E = "MozAppearance" in d.style, b = E && !!t.createRange().compareNode, _ = b ? d : g.parentNode,
        d = e.opera && "[object Opera]" == v.call(e.opera), d = !!t.attachEvent && !d,
        w = E ? "object" : d ? "script" : "img", S = d ? "script" : w, x = Array.isArray || function (e) {
    ...
    p = function (e) {
        function t(e) {
            var t, n, i, e = e.split("!"), o = $.length, r = e.pop(), s = e.length,
        ...
        function s(e, o, r, s, a) {
            var u = t(e), l = u.autoCallback;
            u.url.split(".").pop().split("?").shift(), u.bypass || (o && (o = i(o) ? o : o[e] || o[s] || o[e.split("/").pop().split("?")[0]]), u.instead ? u.instead(e, o, r, s, a) : (I[u.url] ? u.noexec = !0 : I[u.url] = 1, r.load(u.url, u.forceCSS || !u.forceJS && "css" == u.url.split(".").pop().split("?").shift() ? "c" : n, u.noexec, u.attrs, u.timeout), (i(o) || i(l)) && r.load(function () {
        ...
        function a(e, t) {
            function n(e, n) {
                if (e) {
                    if (o(e)) n || (h = function () {
                        ...
                        p.apply(this, e), d()
                    }), s(e, h, t, 0, l); else if (Object(e) === e) for (u in a = function () {
                        var t, n = 0;
            ...
            var a, u, l = !!e.test, c = e.load || e.both, h = e.callback || r, p = h, d = e.complete || r;
            n(l ? e.yep : e.nope, !!c), c && n(c)
        }

        var u, l, h = this.yepnope.loader;
        if (o(e)) s(e, 0, h, 0); else if (x(e)) for (u = 0; u < e.length; u++) l = e[u], o(l) ? s(l, 0, h, 0) : x(l) ? p(l) : Object(l) === l && a(l, h); else Object(e) === e && a(e, h)
        ...
        var c, h, d = t.createElement("script"), o = o || p.errorTimeout;
        d.src = e;
        ...
        var l, o = t.createElement("link"), n = u ? a : n || r;
...
!function (e) {
    var t = function () {
        ...
        return e.prototype.getEnumerator = function () {
            ...
            if (e) for (var t = this.getEnumerator(), n = 0; t.moveNext();) {
            ...
            for (var t = this.getEnumerator(), n = 0; t.moveNext(); n++) if (!e || e(t.current)) return n;
            return -1
...
!function (e) {
    var t = function () {
        function t(e) {
            ...
            var t;
            if (e instanceof Array ? t = e.en() : e && e.getEnumerator instanceof Function && (t = e), t) for (var n = t.getEnumerator(); n && n.moveNext();) this.set(n.current[0], n.current[1])
        }
...
!function (e) {
    function t(e) {
        var t = e.length, n = {moveNext: void 0, current: void 0}, i = -1;
    ...
    try {
        Object.defineProperty(Array.prototype, "en", {value: n, enumerable: !1, writable: !1, configurable: !1})
    } catch (e) {
...
!function (e) {
    ...
    e.Enumerable.prototype.concat = function (n) {
        var i = this, o = n instanceof Array ? n.en() : n, r = new e.Enumerable;
        return r.getEnumerator = function () {
            return t(i, o)
        }, r
        ...
        var n, i = [], o = {
            current: void 0, moveNext: function () {
                if (n || (n = e.getEnumerator()), o.current = void 0, !t) {
                    for (; n.moveNext();) if (i.indexOf(n.current) < 0) return i.push(o.current = n.current), !0;
                    return !1
                }
                for (; n.moveNext();) {
...
!function (e) {
    ...
    e.Enumerable.prototype.except = function (n, i) {
        var o = this, r = n instanceof Array ? n.en() : n, s = new e.Enumerable;
    ...
    for (var r in this.$jsonMappings) if (!(o.indexOf(r) > -1)) {
...
!function (e) {
    ...
    function n(e, t, n) {
        ...
        for (var o, r = [], s = [], a = e.getEnumerator(); a.moveNext();) {
            o = t(a.current);
            for (var u = -1, l = 0, c = s.length; c > l; l++) if (n(o, s[l])) {
                u = l;
                break
            }
            var h;
...
!function (e) {
    function t(t, n, i, o, r, s) {
        ...
        var a, u, l = 0, c = {
            current: void 0, moveNext: function () {
                ...
                var h;
                do {
                    for (; l < u.length; l++) if (h = u[l], s(i(a.current), o(h))) return l++, c.current = r(a.current, h), !0;
                    l = 0
                } while (a.moveNext());
                return !1
            }
    ...
    e.Enumerable.prototype.join = function (n, i, o, r, s) {
        var a = this, u = n instanceof Array ? n.en() : n, l = new e.Enumerable;
...
!function (e) {
    ...
    n.prototype.getEnumerator = function () {
        var e = this, t = e.length, n = {moveNext: void 0, current: void 0}, i = -1;
        return n.moveNext = function () {
            return i++, i >= t ? (n.current = void 0, !1) : (n.current = e[i], !0)
        }, n
...
!function (e) {
    ...
    var n = function (t) {
        ...
        return __extends(n, t), n.prototype.getEnumerator = function () {
            var t, n = this.Source, i = this.Sorter, o = 0, r = {
                current: void 0, moveNext: function () {
    ...
    }(e.Enumerable), i = function (e) {
        function t(t, n, i, o) {
            var r = e.call(this, t, n, i, o) || this, s = t.Sorter, a = r.Sorter;
            return r.Sorter = function (e, t) {
                return s(e, t) || a(e, t)
            }, r
        }
...
!function (e) {
    ...
    e.Enumerable.prototype.traverse = function (n) {
        ...
        var o = this, r = [], s = new e.Enumerable;
...
!function (e) {
    ...
    function n(e) {
        var t = e.getEnumerator(), n = {current: void 0, moveNext: void 0};
        return n.moveNext = function () {
...
!function (e) {
    var t = function () {
        ...
        return e.prototype._init = function () {
            ...
            var i = [].slice.call(arguments, 1), o = ((this._e || (this._e = {}))[e] || []).slice(), r = 0,
                s = o.length;
    ...
    e.BaseComponent = t
}(_Components || (_Components = {})), function (e) {
...
!function (e) {
...
}(HTTPStatusCode || (HTTPStatusCode = {})), function (e) {
    ...
    e.fn.checkboxButton = function (t) {
        return this.each(function () {
            ...
            n.on("click", function (n) {
                var i = n.target.tagName, o = e(this).find(":checkbox");
        ...
        return t || (n = !1), this.each(function () {
            ...
            if (i.append(o), i.css("overflow", "hidden"), o.css("white-space", "nowrap"), o.html(t), o.width() > i.width()) for (var r = null; o.width() > i.width();) {
                var s = o.html();
        ...
        return this.each(function () {
            var i = e(this), o = i.html(), r = e("<span></span>");
        ...
        var t = e(this), n = 0, i = null;
        return t.find("*:visible[tabindex]").each(function (t, o) {
            var r = e(o), s = parseInt(r.attr("tabindex"));
            s > n && (n = s, i = r)
        }), i
        ...
        return this.eq(0).each(function () {
            var n = e(this).is("iframe") ? e(this).contents().find("body") : e(this), i = n.offset();
            t = i.left <= e.mlp.x && i.left + n.outerWidth() > e.mlp.x && i.top <= e.mlp.y && i.top + n.outerHeight() > e.mlp.y
        }), t
    };
    var n, i = e.fn.on;
    e.fn.on = function () {
        var e = Array.apply(null, arguments), t = e[e.length - 1];
        ...
        return this.each(function () {
            var r = e(this), s = r.html();
            if (!(t > s.length)) {
                var a = !1, u = s.substr(0, t);
    ...
    if ("object" == typeof exports && "undefined" != typeof module) module.exports = e(); else if ("function" == typeof define && define.amd) define("lib/manifesto.js", [], e); else {
        var t;
    ...
    return function () {
            ...
            (function (n) {
                ...
                !function (e) {
                    var t = function (t) {
                        ...
                        return o(n, t), n.prototype.getIIIFResourceType = function () {
                            ...
                            var t = this.getProperty("metadata"), n = [];
                            if (!t) return n;
                            for (var i = 0; i < t.length; i++) {
                                var o = t[i], r = new e.LabelValuePair(this.options.locale);
                                r.parse(o), n.push(r)
                            }
                            return n
                    ...
                    var t = function (t) {
                        ...
                        return o(n, t), n.prototype.getFormat = function () {
                            ...
                            for (var n = 0; n < this.__jsonld.resources.length; n++) {
                                var i = this.__jsonld.resources[n], o = new e.Annotation(i, this.options);
                                t.push(o)
                            }
                            return t
                ...
                !function (e) {
                    var t = function (t) {
                        ...
                        return o(n, t), n.prototype.getCanonicalImageUri = function (t) {
                            var n, i = null, o = "full", r = 0, s = "default", a = t;
                            if (this.externalResource && this.externalResource.data && this.externalResource.data["@id"]) i = this.externalResource.data["@id"], a || (a = this.externalResource.data.width), this.externalResource.data["@context"] && (this.externalResource.data["@context"].indexOf("/1.0/context.json") > -1 || this.externalResource.data["@context"].indexOf("/1.1/context.json") > -1 || this.externalResource.data["@context"].indexOf("/1/context.json") > -1) && (s = "native"); else {
                                var u = this.getImages();
                                if (u && u.length) {
                                    var l = u[0], c = l.getResource(), h = c.getServices();
                            ...
                            var t, n = null;
                            return this.externalResource.data && this.externalResource.data.profile && (t = this.externalResource.data.profile, Array.isArray(t) && (t = t.en().where(function (e) {
                                return e.maxWidth
                            }).first(), t && (n = new e.Size(t.maxWidth, t.maxHeight ? t.maxHeight : t.maxWidth)))), n
                        }, n.prototype.getContent = function () {
                            var t = [], n = this.__jsonld.items || this.__jsonld.content;
                            if (!n) return t;
                            var i = null;
                            if (n.length && (i = new e.AnnotationPage(n[0], this.options)), !i) return t;
                            for (var o = i.getItems(), r = 0; r < o.length; r++) {
                                var s = o[r], a = new e.Annotation(s, this.options);
                                t.push(a)
                            }
                            return t
                            ...
                            for (var n = 0; n < this.__jsonld.images.length; n++) {
                                var i = this.__jsonld.images[n], o = new e.Annotation(i, this.options);
                                t.push(o)
                            }
                            return t
                ...
                !function (e) {
                    var t = function (t) {
                        function n(e, n) {
                            ...
                            var o = {defaultLabel: "-", locale: "en-GB", resource: i, pessimisticAccessControl: !1};
                        ...
                        return o(n, t), n.prototype.getAttribution = function () {
                            ...
                            var t = null, n = this.getProperty("requiredStatement");
                            if (n) t = new e.LabelValuePair(this.options.locale), t.parse(n); else {
                ...
                !function (e) {
                    var t = function (t) {
                        function n(e, n) {
                            var i = t.call(this, e, n) || this;
                            if (i.index = 0, i._allRanges = null, i.items = [], i._topRanges = [], i.__jsonld.structures && i.__jsonld.structures.length) for (var o = i._getTopRanges(), r = 0; r < o.length; r++) {
                                var s = o[r];
                        ...
                        return o(n, t), n.prototype.getPosterCanvas = function () {
                            ...
                            if (s) for (var a = 0; a < s.length; a++) {
                                var u = s[a];
                                if (u["@type"] && "sc:range" === u["@type"].toLowerCase() || u.type && "range" === u.type.toLowerCase()) this._parseRanges(u, n + "/" + a, o); else if (u["@type"] && "sc:canvas" === u["@type"].toLowerCase() || u.type && "canvas" === u.type.toLowerCase()) {
                                    o.canvases || (o.canvases = []);
                                    var l = u.id || u["@id"];
                                    o.canvases.push(l)
                                }
                            } else if (t.ranges) for (var a = 0; a < t.ranges.length; a++) this._parseRanges(t.ranges[a], n + "/" + a, o)
                            ...
                            for (var e = this.getTopRanges(), t = 0; t < e.length; t++) {
                                ...
                                var i = n.getRanges();
                                this._allRanges = this._allRanges.concat(i.en().traverseUnique(function (e) {
                                    return e.getRanges()
                                }).toArray())
                            }
                            ...
                            if (t) for (var n = 0; n < t.length; n++) {
                                var i = t[n], o = new e.Sequence(i, this.options);
                                this.items.push(o)
                ...
                !function (e) {
                    var t = function (t) {
                        ...
                        return o(n, t), n.prototype.getCollections = function () {
                            return this._collections ? this._collections : this._collections = this.items.en().where(function (e) {
                                return e.isCollection()
                            }).toArray()
                        }, n.prototype.getManifests = function () {
                            return this._manifests ? this._manifests : this._manifests = this.items.en().where(function (e) {
                                return e.isManifest()
                            }).toArray()
                            ...
                            if (t.getManifests() && t.getManifests().length) for (var n = 0; n < t.getManifests().length; n++) {
                                var i = t.getManifests()[n], o = i.getDefaultTree();
                            ...
                            if (t.getCollections() && t.getCollections().length) for (var n = 0; n < t.getCollections().length; n++) {
                                var i = t.getCollections()[n], o = i.getDefaultTree();
                                o.label = i.parentLabel || e.LanguageMap.getValue(i.getLabel(), this.options.locale) || "collection " + (n + 1), o.navDate = i.getNavDate(), o.data.id = i.id, o.data.type = e.Utils.normaliseType(e.TreeNodeType.COLLECTION.toString()), t.defaultTree.addNode(o), this._parseCollections(i)
                            }
                        }, n
                    }(e.IIIFResource);
                    e.Collection = t
                ...
                !function (e) {
                    var t = function (t) {
                        ...
                        return o(n, t), n.prototype.getCanvasIds = function () {
                            ...
                            var t, n;
                            if (this.canvases && this.canvases.length) for (var i = 0; i < this.canvases.length; i++) {
                                var o = this.canvases[i], r = e.Utils.getTemporalComponent(o);
                                r && r.length > 1 && (0 === i && (t = Number(r[0])), i === this.canvases.length - 1 && (n = Number(r[1])))
                            } else for (var s = this.getRanges(), i = 0; i < s.length; i++) {
                                var a = s[i], u = a.getDuration();
                                u && (0 === i && (t = u.start), i === s.length - 1 && (n = u.end))
                            }
                            return void 0 !== t && void 0 !== n ? new e.Duration(t, n) : void 0
                        }, n.prototype.getRanges = function () {
                            return this._ranges ? this._ranges : this._ranges = this.items.en().where(function (e) {
                                return e.isRange()
                            }).toArray()
                        }, n.prototype.getBehavior = function () {
                            var t = this.getProperty("behavior");
                            ...
                            if (n && n.length) for (var i = 0; i < n.length; i++) {
                                var o = n[i], r = new e.TreeNode;
                ...
                !function (e) {
                    var t = function (t) {
                        ...
                        return o(n, t), n.prototype.getCanvases = function () {
                            ...
                            if (t) for (var n = 0; n < t.length; n++) {
                                var i = t[n], o = new e.Canvas(i, this.options);
                                o.index = n, this.items.push(o)
                            } else if (this.__jsonld) for (var n = 0; n < this.__jsonld.length; n++) {
                                var i = this.__jsonld[n], o = new e.Canvas(i, this.options);
                                o.index = n, this.items.push(o)
                            }
                            return this.items
                        }, n.prototype.getCanvasById = function (t) {
                            for (var n = 0; n < this.getTotalCanvases(); n++) {
                                var i = this.getCanvasByIndex(n), o = e.Utils.normaliseUrl(i.id);
                            ...
                            var i;
                            if (n) {
                                var o = this.getPagedIndices(t), r = this.getViewingDirection();
                            ...
                            if (e) for (var t = 0; t < this.getTotalCanvases(); t++) {
                                var n = this.getCanvasByIndex(t);
                                if (n.id === e) return t
                            }
                            return 0
                            ...
                            for (var i = [], o = this.getTotalCanvases(), r = 0; o > r; r++) {
                                var s = this.getCanvasByIndex(r), a = new e.Thumb(t, s);
                                i.push(a)
                            }
                            return i
                ...
                !function (e) {
                    var t = function () {
                        ...
                        return t.parse = function (e, t) {
                            ...
                            return n ? i.index = n.index || 0 : i.index = 0, this.parseCollections(i, n), this.parseManifests(i, n), this.parseItems(i, n), i
                        }, t.parseCollections = function (e, t) {
                            var n;
                            if (e.__jsonld.collections ? n = e.__jsonld.collections : e.__jsonld.items && (n = e.__jsonld.items.en().where(function (e) {
                                return "collection" === e.type.toLowerCase()
                            }).toArray()), n) for (var i = 0; i < n.length; i++) {
                                t && (t.index = i);
                            ...
                            var n;
                            if (e.__jsonld.manifests ? n = e.__jsonld.manifests : e.__jsonld.items && (n = e.__jsonld.items.en().where(function (e) {
                            ...
                            if (n) for (var i = function (i) {
                                t && (t.index = i);
                                var r = o.parseItem(n[i], t);
                                return r ? e.items.en().where(function (e) {
                                    return e.id === r.id
                                }).first() ? "continue" : (r.index = i, r.parentCollection = e, void e.items.push(r)) : {value: void 0}
                ...
                !function (e) {
                    var t = function () {
                        ...
                        return t.getMediaType = function (e) {
                            ...
                            return [e.__jsonld].en().traverseUnique(function (e) {
                    ...
                    var t = function (t) {
                        ...
                        return o(n, t), n.parse = function (t, n) {
                            ...
                            if (Array.isArray(t)) for (var r = 0; r < t.length; r++) {
                                var s = t[r];
                                i = "string" == typeof s ? new e.Language(s, n) : new e.Language(s["@value"], s["@language"] || n), o.push(i)
                            } else {
                                if ("string" == typeof t) return i = new e.Language(t, n), o.push(i), o;
                                t["@value"] ? (i = new e.Language(t["@value"], t["@language"] || n),
                                    o.push(i)) : Object.keys(t).forEach(function (n) {
                    ...
                    var t = function () {
                        ...
                        return t.prototype.parse = function (t) {
                            ...
                            if (this.label && this.label.length) {
                                var i = this.label.en().where(function (t) {
                            ...
                            if (this.value && this.value.length) {
                                var i = this.value.en().where(function (t) {
                                    return t.locale === n.defaultLocale || t.locale === e.Utils.getInexactLocale(n.defaultLocale)
                                }).first();
                                i && (i.value = t)
                            }
                ...
                !function (e) {
                    ...
                    StatusCodes: {AUTHORIZATION_FAILED: 1, FORBIDDEN: 2, INTERNAL_SERVER_ERROR: 3, RESTRICTED: 4},
                    create: function (e, t) {
                ...
                !function (e) {
                    var t = function (t) {
                        ...
                        return o(n, t), n.prototype.getBody = function () {
                            var t = [], n = this.getProperty("body");
                            if (n) if (Array.isArray(n)) for (var i = 0; i < n.length; i++) {
                                var o = n[i];
                                if (o.items) for (var r = 0; r < o.items.length; r++) {
                                    var s = o.items[r];
                                    t.push(new e.AnnotationBody(s, this.options))
                                } else t.push(new e.AnnotationBody(o, this.options))
                            } else if (n.items) for (var i = 0; i < n.items.length; i++) {
                                var o = n.items[i];
                ...
                !function (e) {
                    var t = function (t) {
                        ...
                        return o(n, t), n.prototype.getIIIFResourceType = function () {
                            ...
                            var t = this, n = this.getProperty("resources");
        ...
        4: [function (e, t, n) {
            (function (t) {
                ...
                function c(e, t) {
                    if (u(t), e = r(e, 0 > t ? 0 : 0 | g(t)), !s.TYPED_ARRAY_SUPPORT) for (var n = 0; t > n; ++n) e[n] = 0;
                    return e
                }
                ...
                function _(e, t, n, i, o) {
                    ...
                    if (o) {
                        var c = -1;
                        for (l = n; a > l; l++) if (r(e, l) === r(t, -1 === c ? 0 : l - c)) {
                            if (-1 === c && (c = l), l - c + 1 === u) return c * s
                        } else -1 !== c && (l -= l - c), c = -1
                    } else for (n + u > a && (n = a - u), l = n; l >= 0; l--) {
                        for (var h = !0, p = 0; u > p; p++) if (r(e, l + p) !== r(t, p)) {
                            h = !1;
                            break
                        }
                        if (h) return l
                ...
                var Z = e("base64-js"), J = e("ieee754"), Q = e("isarray");
                n.Buffer = s, n.SlowBuffer = v, n.INSPECT_MAX_BYTES = 50, s.TYPED_ARRAY_SUPPORT = void 0 !== t.TYPED_ARRAY_SUPPORT ? t.TYPED_ARRAY_SUPPORT : i(), n.kMaxLength = o(), s.poolSize = 8192, s._augment = function (e) {
                    ...
                    if (e === t) return 0;
                    for (var n = e.length, i = t.length, o = 0, r = Math.min(n, i); r > o; ++o) if (e[o] !== t[o]) {
                        n = e[o], i = t[o];
                        break
                    }
                    ...
                    for (var t = 0; e > t; t += 2) E(this, t, t + 1);
                    return this
                }, s.prototype.swap32 = function () {
                    var e = this.length;
                    if (e % 4 !== 0) throw new RangeError("Buffer size must be a multiple of 32-bits");
                    for (var t = 0; e > t; t += 4) E(this, t, t + 3), E(this, t + 1, t + 2);
                    return this
                }, s.prototype.swap64 = function () {
                    var e = this.length;
                    if (e % 8 !== 0) throw new RangeError("Buffer size must be a multiple of 64-bits");
                    for (var t = 0; e > t; t += 8) E(this, t, t + 7), E(this, t + 1, t + 6), E(this, t + 2, t + 5), E(this, t + 3, t + 4);
                    return this
                    ...
                    for (var r = o - i, a = n - t, u = Math.min(r, a), l = this.slice(i, o), c = e.slice(t, n), h = 0; u > h; ++h) if (l[h] !== c[h]) {
                        r = l[h], a = c[h];
                        break
                    }
                ...
                s.prototype.slice = function (e, t) {
                    ...
                    var i;
                    if (s.TYPED_ARRAY_SUPPORT) i = this.subarray(e, t), i.__proto__ = s.prototype; else {
                        var o = t - e;
                        i = new s(o, void 0);
                    ...
                    var o, r = i - n;
                    if (this === e && t > n && i > t) for (o = r - 1; o >= 0; --o) e[o + t] = this[o + n]; else if (1e3 > r || !s.TYPED_ARRAY_SUPPORT) for (o = 0; r > o; ++o) e[o + t] = this[o + n]; else Uint8Array.prototype.set.call(e, this.subarray(n, n + r), t);
                    return r
                    ...
                    if ("number" == typeof e) for (r = t; n > r; ++r) this[r] = e; else {
                        var a = s.isBuffer(e) ? e : W(new s(e, i).toString()), u = a.length;
        ...
        7: [function (e, t, n) {
            ...
            t.exports = i, i.EventEmitter = i, i.prototype._events = void 0, i.prototype._maxListeners = void 0, i.defaultMaxListeners = 10, i.prototype.setMaxListeners = function (e) {
                ...
                } else if (s(n)) for (r = Array.prototype.slice.call(arguments, 1), l = n.slice(), i = l.length, u = 0; i > u; u++) l[u].apply(this, r);
                return !0
                ...
                if (n = this._events[e], r = n.length, i = -1, n === t || o(n.listener) && n.listener === t) delete this._events[e], this._events.removeListener && this.emit("removeListener", e, t); else if (s(n)) {
        ...
        9: [function (e, t, n) {
            n.read = function (e, t, n, i, o) {
                var r, s, a = 8 * o - i - 1, u = (1 << a) - 1, l = u >> 1, c = -7, h = n ? o - 1 : 0, p = n ? -1 : 1,
                    d = e[t + h];
                ...
                var s, a, u, l = 8 * r - o - 1, c = (1 << l) - 1, h = c >> 1,
                    p = 23 === o ? Math.pow(2, -24) - Math.pow(2, -77) : 0, d = i ? 0 : r - 1, f = i ? 1 : -1,
                    g = 0 > t || 0 === t && 0 > 1 / t ? 1 : 0;
        ...
        14: [function (t, n, i) {
            (function (t) {
                !function (o) {
                    ...
                    function p(e, t, n) {
                        var i = 0;
                        for (e = n ? L(e / T) : e >> 1, e += L(e / t); e > N * $ >> 1; i += S) e = L(e / N);
                        return L(i + (N + 1) * e / (e + I))
                    }

                    function d(e) {
                        var t, n, i, o, s, a, u, h, d, f, g = [], v = e.length, m = 0, y = A, E = O;
                        for (n = e.lastIndexOf(C), 0 > n && (n = 0), i = 0; n > i; ++i) e.charCodeAt(i) >= 128 && r("not-basic"), g.push(e.charCodeAt(i));
                        for (o = n > 0 ? n + 1 : 0; v > o;) {
                            for (s = m, a = 1, u = S; o >= v && r("invalid-input"), h = c(e.charCodeAt(o++)), (h >= S || h > L((w - m) / a)) && r("overflow"), m += h * a, d = E >= u ? x : u >= E + $ ? $ : u - E, !(d > h); u += S) f = S - d, a > L(w / f) && r("overflow"), a *= f;
                            t = g.length + 1, E = p(m - s, t, 0 == s), L(m / t) > w - y && r("overflow"), y += L(m / t), m %= t, g.splice(m++, 0, y)
                        }
                        return l(g)
                    }

                    function f(e) {
                        var t, n, i, o, s, a, l, c, d, f, g, v, m, y, E, b = [];
                        for (e = u(e), v = e.length, t = A, n = 0, s = O, a = 0; v > a; ++a) g = e[a], 128 > g && b.push(M(g));
                        for (i = o = b.length, o && b.push(C); v > i;) {
                            for (l = w, a = 0; v > a; ++a) g = e[a], g >= t && l > g && (l = g);
                            for (m = i + 1, l - t > L((w - n) / m) && r("overflow"), n += (l - t) * m, t = l, a = 0; v > a; ++a) if (g = e[a], t > g && ++n > w && r("overflow"), g == t) {
                                for (c = n, d = S; f = s >= d ? x : d >= s + $ ? $ : d - s, !(f > c); d += S) E = c - f, y = S - f, b.push(M(h(f + E % y, 0))), c = L(E / y);
                                b.push(M(h(c, 0))), s = p(n, m, i == o), n = 0, ++i
                            }
                            ++n, ++t
                        }
                        return b.join("")
                    ...
                    var m = "object" == typeof i && i && !i.nodeType && i,
                        y = "object" == typeof n && n && !n.nodeType && n, E = "object" == typeof t && t;
                    (E.global === E || E.window === E || E.self === E) && (o = E);
                    var b, _, w = 2147483647, S = 36, x = 1, $ = 26, I = 38, T = 700, O = 72, A = 128, C = "-",
                        R = /^xn--/, P = /[^\x20-\x7E]/, D = /[\x2E\u3002\uFF0E\uFF61]/g, B = {
                            overflow: "Overflow: input needs wider integers to process",
                            "not-basic": "Illegal input >= 0x80 (not a basic code point)",
                            "invalid-input": "Invalid input"
                        }, N = S - x, L = Math.floor, M = String.fromCharCode;
                    if (b = {
                        version: "1.4.1",
                        ...
                        return b
                    }); else if (m && y) if (n.exports == m) y.exports = b; else for (_ in b) b.hasOwnProperty(_) && (m[_] = b[_]); else o.punycode = b
                }(this)
            }).call(this, "undefined" != typeof global ? global : "undefined" != typeof self ? self : "undefined" != typeof window ? window : {})
        }, {}],
        15: [function (e, t, n) {
            ...
            t.exports = function (e, t, n, r) {
                ...
                u > 0 && l > u && (l = u);
                for (var c = 0; l > c; ++c) {
                    var h, p, d, f, g = e[c].replace(a, "%20"), v = g.indexOf(n);
        ...
        18: [function (e, t, n) {
            ...
            var s = e("process-nextick-args"), a = Object.keys || function (e) {
                var t = [];
        ...
        19: [function (e, t, n) {
            ...
            t.exports = i;
            var o = e("./_stream_transform"), r = e("core-util-is");
        ...
        20: [function (e, t, n) {
            (function (n, i) {
                ...
                function a(t, n) {
                    ...
                    var o = t.highWaterMark, r = t.readableHighWaterMark, s = this.objectMode ? 16 : 16384;
                ...
                function l(e, t, n, i, r) {
                    ...
                    if (null === t) s.reading = !1, g(e, s); else {
                        var a;
                ...
                function y(e, t) {
                    t.readingMore || (t.readingMore = !0, P.nextTick(E, e, t))
                }
                ...
                function b(e) {
                    return function () {
                        var t = e._readableState;
                        H("pipeOnDrain", t.awaitDrain), t.awaitDrain && t.awaitDrain--, 0 === t.awaitDrain && N(e, "data") && (t.flowing = !0, x(e))
                    }
                }
                ...
                function $(e, t) {
                    ...
                    var n;
                    return t.objectMode ? n = t.buffer.shift() : !e || e >= t.length ? (n = t.decoder ? t.buffer.join("") : 1 === t.buffer.length ? t.buffer.head.data : t.buffer.concat(t.length), t.buffer.clear()) : n = I(e, t.buffer, t.decoder), n
                }

                function I(e, t, n) {
                    var i;
                    return e < t.head.data.length ? (i = t.head.data.slice(0, e), t.head.data = t.head.data.slice(e)) : i = e === t.head.data.length ? t.shift() : n ? T(e, t) : O(e, t), i
                }

                function T(e, t) {
                    var n = t.head, i = 1, o = n.data;
                ...
                function O(e, t) {
                    var n = M.allocUnsafe(e), i = t.head, o = 1;
                    for (i.data.copy(n), e -= i.data.length; i = i.next;) {
                        var r = i.data, s = e > r.length ? r.length : e;
                ...
                }), L = e("./internal/streams/stream"), M = e("safe-buffer").Buffer, U = i.Uint8Array || function () {
                }, F = e("core-util-is");
                F.inherits = e("inherits");
                var k = e("util"), H = void 0;
                H = k && k.debuglog ? k.debuglog("stream") : function () {
                };
                var V, G = e("./internal/streams/BufferList"), j = e("./internal/streams/destroy");
                F.inherits(u, L);
                ...
                u.prototype.read = function (e) {
                    ...
                    if (0 !== e && (t.emittedReadable = !1), 0 === e && t.needReadable && (t.length >= t.highWaterMark || t.ended)) return H("read: emitReadable", t.length, t.ended), 0 === t.length && t.ended ? A(this) : v(this), null;
                    ...
                    var o;
                    return o = e > 0 ? $(e, t) : null, null === o ? (t.needReadable = !0, e = 0) : t.length -= e, 0 === t.length && (t.ended || (t.needReadable = !0), n !== e && t.ended && A(this)), null !== o && this.emit("data", o), o
                    ...
                    var p = this, d = this._readableState;
                    switch (d.pipesCount) {
                        case 0:
                            d.pipes = e;
                            break;
                    ...
                    var f = (!t || t.end !== !1) && e !== n.stdout && e !== n.stderr, g = f ? o : h;
                    ...
                    for (var r = 0; r < W.length; r++) e.on(W[r], this.emit.bind(this, W[r]));
        ...
        22: [function (e, t, n) {
            (function (n, i, o) {
                ...
                function l(t, n) {
                    ...
                    var o = t.highWaterMark, s = t.writableHighWaterMark, a = this.objectMode ? 16 : 16384;
                ...
                function p(e, t, n, i) {
                    var o = !0, r = !1;
                    return null === n ? r = new TypeError("May not write null values to stream") : "string" == typeof n || void 0 === n || t.objectMode || (r = new TypeError("Invalid non-string/buffer chunk")), r && (e.emit("error", r), O.nextTick(i, r), o = !1), o
                }
                ...
                function v(e, t, n, i, o) {
                    --t.pendingcb, n ? (O.nextTick(o, i), O.nextTick($, e, t), e._writableState.errorEmitted = !0, e.emit("error", i)) : (o(i), e._writableState.errorEmitted = !0, e.emit("error", i), $(e, t))
                }
                ...
                function y(e, t) {
                    ...
                    if (m(n), t) v(e, n, i, t, o); else {
                        var r = w(n);
                        r || n.corked || n.bufferProcessing || !n.bufferedRequest || _(e, n), i ? C(E, e, n, r, o) : E(e, n, r, o)
                    }
                }

                function E(e, t, n, i) {
                    n || b(e, t), t.pendingcb--, i(), $(e, t)
                }
                ...
                function _(e, t) {
                    ...
                    if (e._writev && n && n.next) {
                        ...
                        for (; n;) {
                            var l = n.chunk, c = n.encoding, h = n.callback, p = t.objectMode ? 1 : l.length;
                ...
                function S(e, t) {
                    e._final(function (n) {
                        t.pendingcb--, n && e.emit("error", n), t.prefinished = !0, e.emit("prefinish"), $(e, t)
                    })
                }
                ...
                function I(e, t, n) {
                    t.ending = !0, $(e, t), n && (t.finished ? O.nextTick(n) : e.once("finish", n)), t.ended = !0, e.writable = !1
                }
                ...
                t.exports = c;
                var A, C = !n.browser && ["v0.10", "v0.9."].indexOf(n.version.slice(0, 5)) > -1 ? o : O.nextTick;
                c.WritableState = l;
                var R = e("core-util-is");
                R.inherits = e("inherits");
                var P = {deprecate: e("util-deprecate")}, D = e("./internal/streams/stream"),
                    B = e("safe-buffer").Buffer, N = i.Uint8Array || function () {
                ...
                "function" == typeof Symbol && Symbol.hasInstance && "function" == typeof Function.prototype[Symbol.hasInstance] ? (M = Function.prototype[Symbol.hasInstance], Object.defineProperty(c, Symbol.hasInstance, {
                    ...
                    var i = this._writableState, o = !1, r = !i.objectMode && a(e);
                    ...
                    "function" == typeof e ? (n = e, e = null, t = null) : "function" == typeof t && (n = t, t = null), null !== e && void 0 !== e && this.write(e, t), i.corked && (i.corked = 1, this.uncork()), i.ending || i.finished || I(this, i, n)
        ...
        23: [function (e, t, n) {
            ...
            var r = e("safe-buffer").Buffer, s = e("util");
            t.exports = function () {
                function e() {
        ...
        24: [function (e, t, n) {
            ...
            function i(e, t) {
                var n = this, i = this._readableState && this._readableState.destroyed,
        ...
        27: [function (e, t, n) {
            ...
            function o(e) {
                var t = i(e);
                if ("string" != typeof t && (y.isEncoding === E || !E(e))) throw new Error("Unknown encoding: " + e);
                return t || e
            }
            ...
            var y = e("safe-buffer").Buffer, E = y.isEncoding || function (e) {
        ...
        30: [function (e, t, n) {
            (function (t) {
                var i = e("./lib/request"), o = e("./lib/response"), r = e("xtend"), s = e("builtin-status-codes"),
                    a = e("url"), u = n;
                u.request = function (e, n) {
                    e = "string" == typeof e ? a.parse(e) : r(e);
                    var o = -1 === t.location.protocol.search(/^https?:$/) ? "http:" : "", s = e.protocol || o,
                        u = e.hostname || e.host, l = e.port, c = e.path || "/";
                    ...
                    var n = u.request(e, t);
                    return n.end(), n
                }, u.ClientRequest = i, u.IncomingMessage = o.IncomingMessage, u.Agent = function () {
        ...
        }, {"./lib/request": 32, "./lib/response": 33, "builtin-status-codes": 5, url: 36, xtend: 39}],
        31: [function (e, t, n) {
            (function (e) {
                function t() {
        ...
        32: [function (e, t, n) {
            (function (n, i, o) {
                ...
                var a = e("./capability"), u = e("inherits"), l = e("./response"), c = e("readable-stream"),
                    h = e("to-arraybuffer"), p = l.IncomingMessage, d = l.readyStates, f = t.exports = function (e) {
                        var t = this;
                        ...
                        var n, i = !0;
                        if ("disable-fetch" === e.mode || "requestTimeout" in e && !a.abortController) i = !1, n = !0; else if ("prefer-streaming" === e.mode) n = !1; else if ("allow-wrong-content-type" === e.mode) n = !a.overrideMimeType; else {
        ...
        33: [function (e, t, n) {
            (function (t, i, o) {
                var r = e("./capability"), s = e("inherits"), a = e("readable-stream"),
        ...
        34: [function (e, t, n) {
            (function (t, i) {
                ...
                var r = e("process/browser.js").nextTick, s = Function.prototype.apply, a = Array.prototype.slice,
                    u = {}, l = 0;
                n.setTimeout = function () {
                    ...
                    var t = l++, i = arguments.length < 2 ? !1 : a.call(arguments, 1);
        ...
        36: [function (e, t, n) {
            ...
            var c = /^([a-z0-9.+-]+:)/i, h = /:[0-9]*$/, p = /^(\/\/?(?!\/)[^\?\s]*)(\?[^\s]*)?$/,
                d = ["<", ">", '"', "`", " ", "\r", "\n", "	"], f = ["{", "}", "|", "\\", "^", "`"].concat(d),
                g = ["'"].concat(f), v = ["%", "/", "?", ";", "#"].concat(g), m = ["/", "?", "#"], y = 255,
                E = /^[+a-z0-9A-Z_-]{0,63}$/, b = /^([+a-z0-9A-Z_-]{0,63})(.*)$/,
                _ = {javascript: !0, "javascript:": !0}, w = {javascript: !0, "javascript:": !0}, S = {
                    http: !0,
                    https: !0,
                    ftp: !0,
                    gopher: !0,
            ...
            i.prototype.parse = function (e, t, n) {
                ...
                var i = e.indexOf("?"), o = -1 !== i && i < e.indexOf("#") ? "?" : "#", r = e.split(o), s = /\\/g;
                r[0] = r[0].replace(s, "/"), e = r.join(o);
                var a = e;
                if (a = a.trim(), !n && 1 === e.split("#").length) {
                    var h = p.exec(a);
                    if (h) return this.path = a, this.href = a, this.pathname = h[1], h[2] ? (this.search = h[2], t ? this.query = x.parse(this.search.substr(1)) : this.query = this.search.substr(1)) : t && (this.search = "", this.query = {}), this
                }
                var d = c.exec(a);
                if (d) {
                    d = d[0];
                ...
                if (!w[d] && ($ || d && !S[d])) {
                    ...
                    var A, C;
                    C = -1 === I ? a.lastIndexOf("@") : a.lastIndexOf("@", I), -1 !== C && (A = a.slice(0, C), a = a.slice(C + 1), this.auth = decodeURIComponent(A)), I = -1;
                    ...
                    if (!R) for (var P = this.hostname.split(/\./), T = 0, D = P.length; D > T; T++) {
                        var B = P[T];
                        if (B && !B.match(E)) {
                            for (var N = "", L = 0, M = B.length; M > L; L++) N += B.charCodeAt(L) > 127 ? "x" : B[L];
                            if (!N.match(E)) {
                                var U = P.slice(0, T), F = P.slice(T + 1), k = B.match(b);
                ...
                if (!_[f]) for (var T = 0, D = g.length; D > T; T++) {
                    var G = g[T];
                    if (-1 !== a.indexOf(G)) {
                ...
                var q = a.indexOf("?");
                if (-1 !== q ? (this.search = a.substr(q), this.query = a.substr(q + 1), t && (this.query = x.parse(this.query)), a = a.slice(0, q)) : t && (this.search = "", this.query = {}), a && (this.pathname = a), S[f] && this.hostname && !this.pathname && (this.pathname = "/"), this.pathname || this.search) {
                    var H = this.pathname || "", z = this.search || "";
                    this.path = H + z
                }
                ...
                var t = this.protocol || "", n = this.pathname || "", i = this.hash || "", o = !1, r = "";
                this.host ? o = e + this.host : this.hostname && (o = e + (-1 === this.hostname.indexOf(":") ? this.hostname : "[" + this.hostname + "]"), this.port && (o += ":" + this.port)), this.query && l.isObject(this.query) && Object.keys(this.query).length && (r = x.stringify(this.query));
                var s = this.search || r && "?" + r || "";
                return t && ":" !== t.substr(-1) && (t += ":"), this.slashes || (!t || S[t]) && o !== !1 ? (o = "//" + (o || ""), n && "/" !== n.charAt(0) && (n = "/" + n)) : o || (o = ""), i && "#" !== i.charAt(0) && (i = "#" + i), s && "?" !== s.charAt(0) && (s = "?" + s), n = n.replace(/[?#]/g, function (e) {
                ...
                var m = n.pathname && "/" === n.pathname.charAt(0),
                    y = e.host || e.pathname && "/" === e.pathname.charAt(0), E = y || m || n.host && e.pathname, b = E,
                    _ = n.pathname && n.pathname.split("/") || [], f = e.pathname && e.pathname.split("/") || [],
                    x = n.protocol && !S[n.protocol];
                if (x && (n.hostname = "", n.port = null, n.host && ("" === _[0] ? _[0] = n.host : _.unshift(n.host)), n.host = "", e.protocol && (e.hostname = null, e.port = null, e.host && ("" === f[0] ? f[0] = e.host : f.unshift(e.host)), e.host = null), E = E && ("" === f[0] || "" === _[0])), y) n.host = e.host || "" === e.host ? e.host : n.host, n.hostname = e.hostname || "" === e.hostname ? e.hostname : n.hostname, n.search = e.search, n.query = e.query, _ = f; else if (f.length) _ || (_ = []), _.pop(), _ = _.concat(f), n.search = e.search, n.query = e.query; else if (!l.isNullOrUndefined(e.search)) {
                    if (x) {
                ...
                for (var I = _.slice(-1)[0], T = (n.host || e.host || _.length > 1) && ("." === I || ".." === I) || "" === I, O = 0, A = _.length; A >= 0; A--) I = _[A], "." === I ? _.splice(A, 1) : ".." === I ? (_.splice(A, 1), O++) : O && (_.splice(A, 1), O--);
                if (!E && !b) for (; O--; O) _.unshift("..");
                !E || "" === _[0] || _[0] && "/" === _[0].charAt(0) || _.unshift(""), T && "/" !== _.join("/").substr(-1) && _.push("");
                ...
                return E = E || n.host && _.length, E && !C && _.unshift(""), _.length ? n.pathname = _.join("/") : (n.pathname = null, n.path = null), l.isNull(n.pathname) && l.isNull(n.search) || (n.path = (n.pathname ? n.pathname : "") + (n.search ? n.search : "")), n.auth = e.auth || n.auth, n.slashes = n.slashes || e.slashes, n.href = n.format(), n
    ...
    if ("object" == typeof exports && "undefined" != typeof module) module.exports = e(); else if ("function" == typeof define && define.amd) define("lib/manifold.js", [], e); else {
        var t;
                ...
                !function (t) {
                    var n = function () {
                        ...
                        return n.prototype.bootstrap = function (t, n) {
                            ...
                            if (e._options.iiifResource || (e._options.iiifResource = r), r.getIIIFResourceType().toString() === manifesto.IIIFResourceType.collection().toString() || "collection" === r.getIIIFResourceType().toString().toLowerCase()) {
                                var s = r.getCollections();
                                s && s.length ? r.getCollectionByIndex(e._options.collectionIndex).then(function (n) {
                                    n || o("Collection index not found"), 0 === n.getTotalManifests() && 0 === e._options.manifestIndex && n.getTotalCollections() > 0 ? (e._options.collectionIndex = 0, e._options.iiifResourceUri = n.id, e.bootstrap(i, o)) : n.getManifestByIndex(e._options.manifestIndex).then(function (n) {
                ...
                !function (e) {
                    var t = function () {
                        ...
                        return e.prototype._getImageServiceDescriptor = function (e) {
                            ...
                            var t = e.getContent(), n = e.getImages(), i = null;
                            if (t && t.length) {
                                var o = t[0], r = o.getBody();
                                if (r.length) {
                                    var s = r[0], a = s.getServices();
                                    return a.length && (i = this._getImageServiceDescriptor(a)) ? i : r[0].id
                                }
                                return null
                            }
                            if (n && n.length) {
                                var u = n[0], l = u.getResource(), a = l.getServices();
                            ...
                            return n.data = {}, new Promise(function (i, o) {
                                if (t.dataUri || o("There is no dataUri to fetch"), n.probeService && !n.isProbed) n.isProbed = !0, $.ajax({
                                    ...
                                    $.ajax({
                                        url: n.dataUri, type: r, dataType: "json", beforeSend: function (t) {
                    ...
                    var t = function () {
                        ...
                        return t.prototype.getAutoCompleteService = function () {
                            ...
                            for (var t = [], n = 0; n < e.length; n++) {
                                var i = e[n], o = this.getCanvasById(i);
                                o && t.push(o)
                            }
                            return t
                            ...
                            var n = [], i = this.manifest.getMetadata(), o = new e.MetadataGroup(this.manifest);
                            ...
                            if (this.manifest.getLogo()) {
                                var a = {label: "logo", value: '<img src="' + this.manifest.getLogo() + '"/>'},
                                    r = new Manifesto.LabelValuePair(this.options.locale);
                                r.parse(a), r.isRootLevel = !0, o.addItem(r)
                            }
                            ...
                            var i = this.getCurrentSequence(), o = i.getMetadata();
                            if (o && o.length) {
                            ...
                            if (t.canvases && t.canvases.length) for (var a = 0; a < t.canvases.length; a++) {
                                var u = t.canvases[a], l = u.getMetadata();
                                if (l && l.length) {
                                    var c = new e.MetadataGroup(u);
                                    c.addMetadata(u.getMetadata()), n.push(c)
                                }
                                for (var h = u.getImages(), p = 0; p < h.length; p++) {
                                    var d = h[p], f = d.getMetadata();
                                    if (f && f.length) {
                            ...
                            var t = null;
                            if (t = e ? e : this.getCurrentRange()) for (var n = this.getFlattenedTree(), i = 0; i < n.length; i++) {
                                var o = n[i];
                                if (o.data.id === t.id) {
                                    for (; i > 0;) {
                                        i--;
                            ...
                            var e = null, t = this.manifest.getService(manifesto.ServiceProfile.shareExtensions());
                            ...
                            }).toArray(), i = t.nodes.en().traverseUnique(function (e) {
                                return e.nodes
                            }).where(function (e) {
                            ...
                            var i;
                            if (this.iiifResource.isCollection()) i = this.iiifResource.getDefaultTree(); else {
                                var o = this._getTopRanges(), r = new manifesto.TreeNode;
                            ...
                            for (var n = 0; n < t.length; n++) {
                                var i = t[n], o = this.getNodeYear(i), r = this.getNodeMonth(i),
                            ...
                            for (var n = 0; n < t.length; n++) {
                                var i = t[n], o = this.getNodeYear(i), r = Number(o.toString().substr(0, 3) + "9");
                            ...
                            for (var n = 0; n < t.length; n++) {
                                var i = t[n], o = this.getNodeYear(i), r = this.getNodeMonth(i),
                                    s = this.getDecadeNode(e, o), a = null;
                            ...
                            for (var n = 0; n < t.length; n++) {
                                var i = t[n], o = this.getNodeYear(i), r = this.getDecadeNode(e, o);
                            ...
                            for (var t = this, n = 0; n < e.nodes.length; n++) for (var i = e.nodes[n], o = 0; o < i.nodes.length; o++) {
                                var r = i.nodes[o];
...
!function (e) {
    ...
    var o = function () {
        ...
        return e.float32ColorToARGB = function (e) {
            var t = (4278190080 & e) >>> 24, n = (16711680 & e) >>> 16, i = (65280 & e) >>> 8, o = 255 & e,
                r = [t, n, i, o];
            return r
    ...
    var E = function () {
        ...
        return e.ellipsis = function (e, t) {
            ...
            var n = e.substr(0, t), i = n.lastIndexOf(" ");
    ...
    var b = function () {
        ...
        return e.getHashParameter = function (e, t) {
            ...
            if (n || (n = window.document), n && n.location) {
                var i = this.updateURIKeyValuePair(n.location.hash.replace("#?", ""), e, t), o = "#?" + i, r = n.URL,
                    s = r.indexOf("#");
            ...
            var i = e.split("&");
            "" == i[0] && i.shift();
            for (var o, r = i.length; r--;) if (o = i[r].split("="), o[0] == t) {
                o[1] = n, i[r] = o.join("=");
                break
            }
            ...
            var t = this.getUrlParts(e), n = t.pathname + t.searchWithin;
    ...
    1: [function (e, t, n) {
        ...
        function y(e, t) {
            ...
            var i = !Array.isArray(e), o = [], r = !1;
            return {
                onIgnoreTag: function (e, i, s) {
                    if (n(e)) {
                        if (s.isClosing) {
                            var a = "[/removed]", u = s.position + a.length;
        ...
        var _ = e("cssfilter").FilterCSS, w = e("cssfilter").getDefaultWhiteList, S = e("./util"), x = new _, $ = /</g,
            I = />/g, T = /"/g, O = /&quot;/g, A = /&#([a-zA-Z0-9]*);?/gim, C = /&colon;?/gim, R = /&newline;?/gim,
            P = /((j\s*a\s*v\s*a|v\s*b|l\s*i\s*v\s*e)\s*s\s*c\s*r\s*i\s*p\s*t\s*|m\s*o\s*c\s*h\s*a)\:/gi,
            D = /e\s*x\s*p\s*r\s*e\s*s\s*s\s*i\s*o\s*n\s*\(.*/gi, B = /u\s*r\s*l\s*\(.*/gi, N = /<!--[\s\S]*?-->/g;
        ...
        var r = e("./default"), s = e("./parser"), a = e("./xss");
        ...
        function r(e, t, n) {
            "user strict";
            var r = "", s = 0, a = !1, u = !1, l = 0, c = e.length, h = "", p = "";
            for (l = 0; c > l; l++) {
                var d = e.charAt(l);
                if (a === !1) {
                    if ("<" === d) {
        ...
        function s(e, t) {
            ...
            for (var i = 0, o = [], r = !1, s = e.length, l = 0; s > l; l++) {
                ...
                if (r !== !1 || "=" !== g) if (r === !1 || l !== i || '"' !== g && "'" !== g || "=" !== e.charAt(l - 1)) if (/\s|\n|\t/.test(g)) {
                    if (e = e.replace(/\s|\n|\t/g, " "), r === !1) {
                        if (f = a(e, l), -1 === f) {
        ...
        var a = e("cssfilter").FilterCSS, u = e("./default"), l = e("./parser"), c = l.parseTag, h = l.parseAttr,
            p = e("./util");
        s.prototype.process = function (e) {
            if (e = e || "", e = e.toString(), !e) return "";
            var t = this, n = t.options, r = n.whiteList, s = n.onTag, a = n.onIgnoreTag, l = n.onTagAttr,
                d = n.onIgnoreTagAttr, f = n.safeAttrValue, g = n.escapeHtml, v = t.cssFilter;
            ...
            var y = c(e, function (e, t, n, u, c) {
                var m = {sourcePosition: e, position: t, isClosing: c, isWhite: r.hasOwnProperty(n)}, y = s(n, u, m);
                if (!i(y)) return y;
                if (m.isWhite) {
                    if (m.isClosing) return "</" + n + ">";
                    var E = o(u), b = r[n], _ = h(E.html, function (e, t) {
                        var o = -1 !== p.indexOf(b, e), r = l(n, e, t, o);
                        if (!i(r)) return r;
                        if (o) return t = f(n, e, t, v), t ? e + '="' + t + '"' : e;
                        var r = d(n, e, t, o);
                        return i(r) ? void 0 : r
                    }), u = "<" + n;
                    return _ && (u += " " + _), E.closing && (u += " /"), u += ">"
                }
                var y = a(n, u, m);
                return i(y) ? g(u) : y
            }, g);
        ...
        var s = e("./default"), a = e("./parser");
        e("./util");
        r.prototype.process = function (e) {
            if (e = e || "", e = e.toString(), !e) return "";
            var t = this, n = t.options, o = n.whiteList, r = n.onAttr, s = n.onIgnoreAttr, u = n.safeAttrValue,
        ...
        function i(e, t) {
            function n() {
                if (!r) {
                    var n = o.trim(e.slice(s, a)), i = n.indexOf(":");
                    if (-1 !== i) {
                        var l = o.trim(n.slice(0, i)), c = o.trim(n.slice(i + 1));
                        if (l) {
...
define("modules/uv-shared-module/Dialogue", ["require", "exports", "./BaseView", "./BaseEvents"], function (e, t, n, i) {
    ...
    var o = function (e) {
        ...
        return __extends(t, e), t.prototype.create = function () {
            var t = this;
            this.setConfig("dialogue"), e.prototype.create.call(this), $.subscribe(i.BaseEvents.CLOSE_ACTIVE_DIALOGUE, function () {
            ...
            var e = Math.floor(this.extension.height() - this.$element.outerHeight(!0)), t = 0, n = 0, i = 0;
            if (this.$triggerButton) {
                var o = 4, r = 2, s = this.$triggerButton.offset().top, a = this.extension.$element.offset().top,
                    u = this.$element.outerHeight(!0), l = s - a - u;
                e = l + o;
                var c = this.$triggerButton.offset().left, h = this.extension.$element.offset().left, p = c - h;
            ...
            this.$bottom.css("backgroundPosition", n + "px 0px"), this.$element.css({top: e, left: t})
        }, t.prototype.open = function (e) {
            var t = this;
            this.$element.attr("aria-hidden", "false"), this.$element.show(), e && e.length ? (this.$triggerButton = e, this.$bottom.show()) : this.$bottom.hide(), this.isActive = !0, setTimeout(function () {
                var e = t.$element.find(".default");
                if (e.length) e.focus(); else {
                    var n = t.$element.find("input:visible").first();
                    n.length ? n.focus() : t.$closeButton.focus()
                }
            }, 1), $.publish(i.BaseEvents.SHOW_OVERLAY), this.isUnopened && (this.isUnopened = !1, this.afterFirstOpen()), this.resize()
        }, t.prototype.afterFirstOpen = function () {
        }, t.prototype.close = function () {
            this.isActive && (this.$element.attr("aria-hidden", "true"), this.$element.hide(), this.isActive = !1, $.publish(this.closeCommand), $.publish(i.BaseEvents.HIDE_OVERLAY))
        }, t.prototype.resize = function () {
...
define("modules/uv-shared-module/GenericDialogue", ["require", "exports", "./BaseEvents", "./Dialogue"], function (e, t, n, i) {
    ...
    var o = function (e) {
        ...
        return __extends(t, e), t.prototype.create = function () {
            var t = this;
            this.setConfig("genericDialogue"), e.prototype.create.call(this), this.openCommand = n.BaseEvents.SHOW_GENERIC_DIALOGUE, this.closeCommand = n.BaseEvents.HIDE_GENERIC_DIALOGUE, $.subscribe(this.openCommand, function (e, n) {
...
define("modules/uv-shared-module/Shell", ["require", "exports", "./BaseEvents", "./BaseView", "./GenericDialogue"], function (e, t, n, i, o) {
    ...
    var r = function (e) {
        ...
        return __extends(t, e), t.prototype.create = function () {
            e.prototype.create.call(this), $.subscribe(n.BaseEvents.SHOW_OVERLAY, function () {
                t.$overlays.show()
            }), $.subscribe(n.BaseEvents.HIDE_OVERLAY, function () {
                t.$overlays.hide()
            }), t.$headerPanel = $('<div class="headerPanel"></div>'), t.$element.append(t.$headerPanel), t.$mainPanel = $('<div class="mainPanel"></div>'), t.$element.append(t.$mainPanel), t.$centerPanel = $('<div class="centerPanel"></div>'), t.$mainPanel.append(t.$centerPanel), t.$leftPanel = $('<div class="leftPanel"></div>'), t.$mainPanel.append(t.$leftPanel), t.$rightPanel = $('<div class="rightPanel"></div>'), t.$mainPanel.append(t.$rightPanel), t.$footerPanel = $('<div class="footerPanel"></div>'), t.$element.append(t.$footerPanel), t.$mobileFooterPanel = $('<div class="mobileFooterPanel"></div>'), t.$element.append(t.$mobileFooterPanel), t.$overlays = $('<div class="overlays"></div>'), t.$element.append(t.$overlays), t.$genericDialogue = $('<div class="overlay genericDialogue" aria-hidden="true"></div>'), t.$overlays.append(t.$genericDialogue), t.$overlays.on("click", function (e) {
                $(e.target).hasClass("overlays") && (e.preventDefault(), $.publish(n.BaseEvents.CLOSE_ACTIVE_DIALOGUE))
            }), new o.GenericDialogue(t.$genericDialogue)
        }, t.prototype.resize = function () {
            var n = this;
            e.prototype.resize.call(this), setTimeout(function () {
                t.$overlays.width(n.extension.width()), t.$overlays.height(n.extension.height())
            }, 1);
            var i = this.$element.height() - parseInt(t.$mainPanel.css("paddingTop")) - (t.$headerPanel.is(":visible") ? t.$headerPanel.height() : 0) - (t.$footerPanel.is(":visible") ? t.$footerPanel.height() : 0) - (t.$mobileFooterPanel.is(":visible") ? t.$mobileFooterPanel.height() : 0);
            t.$mainPanel.height(i)
        }, t
    }(i.BaseView);
    t.Shell = r
...
define("modules/uv-shared-module/CenterPanel", ["require", "exports", "./Shell", "./BaseView", "./Position", "../../Utils"], function (e, t, n, i, o, r) {
    "use strict";
    Object.defineProperty(t, "__esModule", {value: !0});
    var s = function (e) {
        function t(t) {
            var n = e.call(this, t, !1, !0) || this;
            return n.subtitleExpanded = !1, n.isAttributionOpen = !1, n.attributionPosition = o.Position.BOTTOM_LEFT, n
        }
        ...
        return __extends(t, e), t.prototype.create = function () {
            ...
            var e = this, t = this.extension.helper.getRequiredStatement(),
                n = Utils.Bools.getBool(this.options.requiredStatementEnabled, !0);
            if (t && t.value && n) {
                this.openAttribution();
                var i = this.$attribution.find(".title"), o = this.$attribution.find(".attribution-text"),
                    s = this.$attribution.find(".license"), a = this.$attribution.find(".logo");
                if (t.label) {
                ...
                if (t.value) {
                    ...
                    o.html(l), o.find("img").one("load", function () {
                        e.resize()
                    }).each(function () {
            ...
            var t = n.Shell.$leftPanel.is(":visible") ? Math.floor(n.Shell.$leftPanel.width()) : 0,
                ...
                s = Math.floor(this.$element.parent().width() - t - i);
            this.$element.css({left: t, width: s});
            var a, u;
            if (a = this.options && this.options.titleEnabled === !1 || !this.$title.is(":visible") ? 0 : this.$title.height(), u = this.options && this.options.subtitleEnabled === !1 || !this.$subtitle.is(":visible") ? 0 : this.$subtitle.height(), this.$content.height(this.$element.height() - a - u), this.$content.width(this.$element.width()), this.$attribution && this.isAttributionOpen) {
...
define("modules/uv-avcenterpanel-module/AVCenterPanel", ["require", "exports", "../uv-shared-module/BaseEvents", "../uv-shared-module/CenterPanel", "../uv-shared-module/Position", "../../Utils"], function (e, t, n, i, o, r) {
    ...
    var s = function (e) {
        ...
        return __extends(t, e), t.prototype.create = function () {
            ...
            var e = this;
            this.$avcomponent = $('<div class="iiif-av-component"></div>'), this.$content.prepend(this.$avcomponent), this.avcomponent = new IIIFComponents.AVComponent({target: this.$avcomponent[0]}), this.avcomponent.on("mediaready", function () {
            ...
            var e, t, n = this, i = "", o = this.extension.helper.getCurrentRange();
            ...
            for (var s = this.extension.helper.getMetadata({range: o}), a = 0; a < s.length; a++) {
                var u = s[a], l = u.items.find(function (e) {
                    if (e.label) {
    ...
    var s = function () {
        ...
        return e.loadExternalResources = function (t, i) {
            ...
            return new Promise(function (t) {
                $.publish(n.BaseEvents.SHOW_CLICKTHROUGH_DIALOGUE, [{
                    resource: e, acceptCallback: function () {
                        if (e.clickThroughService) var i = window.open(e.clickThroughService.id),
                            o = window.setInterval(function () {
                                i && i.closed && (window.clearInterval(o), $.publish(n.BaseEvents.CLICKTHROUGH), t())
                            }, 500)
                    }
                }])
            })
            ...
            return new Promise(function (t) {
                var i = {};
                e.status === HTTPStatusCode.FORBIDDEN && (i.warningMessage = r.LoginWarningMessages.FORBIDDEN, i.showCancelButton = !0), $.publish(n.BaseEvents.SHOW_LOGIN_DIALOGUE, [{
                    resource: e,
                    loginCallback: function () {
                        if (e.loginService) var i = window.open(e.loginService.id + "?t=" + (new Date).getTime()),
                            o = window.setInterval(function () {
                                i && i.closed && (window.clearInterval(o), $.publish(n.BaseEvents.LOGIN), t())
                            }, 500)
                    },
                    logoutCallback: function () {
                        if (e.logoutService) var i = window.open(e.logoutService.id + "?t=" + (new Date).getTime()),
                            o = window.setInterval(function () {
                                i && i.closed && (window.clearInterval(o), $.publish(n.BaseEvents.LOGOUT), t())
                            }, 500)
                    },
                    options: i
                }])
            ...
            return new Promise(function (n, i) {
                if (e.tokenService) {
                    var o = e.tokenService.id, r = o + "|" + (new Date).getTime(), s = function (e) {
            ...
            return new Promise(function (n, i) {
                var o = [], r = null;
                if (e.tokenService && (r = Utils.Storage.get(e.tokenService.id, new Utils.StorageType(t))), r) o.push(r); else for (var s = Utils.Urls.getUrlParts(e.dataUri).hostname, a = Utils.Storage.getItems(new Utils.StorageType(t)), u = 0; u < a.length; u++) r = a[u], r.key.includes(s) && o.push(r);
            ...
            return new Promise(function (t, r) {
                if (e.isResponseHandled = !0, e.status === HTTPStatusCode.OK) t(e); else if (e.status === HTTPStatusCode.MOVED_TEMPORARILY) t(e), $.publish(n.BaseEvents.RESOURCE_DEGRADED, [e]); else if (e.error.status === HTTPStatusCode.UNAUTHORIZED || e.error.status === HTTPStatusCode.INTERNAL_SERVER_ERROR) if (Modernizr.cors) r(e.error.statusText); else {
                    ...
                    var a = new Error;
                    a.message = "Forbidden", a.name = manifesto.StatusCodes.FORBIDDEN.toString(), r(a)
    ...
    var s = function () {
        ...
        return e.loadExternalResources = function (t, i, o) {
            ...
            return new Promise(function (n, i) {
                var o = [], r = null;
                if (t.tokenService && (r = Utils.Storage.get(t.tokenService.id, new Utils.StorageType(e.storageStrategy))), r) o.push(r); else for (var s = Utils.Urls.getUrlParts(t.dataUri).hostname, a = Utils.Storage.getItems(new Utils.StorageType(e.storageStrategy)), u = 0; u < a.length; u++) r = a[u], r.key.includes(s) && o.push(r);
                o = o.sort(function (e, t) {
                    return e.expiresAt - t.expiresAt
                });
                var l = null;
            ...
            return new Promise(function (o) {
                t.isResponseHandled && !t.authHoldingPage ? (e.showDegradedMessage(t), o(null)) : t.authHoldingPage ? (t.authHoldingPage.location.href = e.getCookieServiceUrl(i), o(t.authHoldingPage)) : $.publish(n.BaseEvents.SHOW_AUTH_DIALOGUE, [{
                    service: i,
            ...
            return new Promise(function (i, o) {
                var r = e.getOrigin(n.id), s = (new Date).getTime();
                e.messages[s] = {
                    resolve: i,
                    reject: o,
                    serviceOrigin: r,
            ...
            if (e.status != HTTPStatusCode.MOVED_TEMPORARILY) {
                var o = "";
                t.getFailureHeader() && (o += "<p>" + t.getFailureHeader() + "</p>"), t.getFailureDescription() && (o += t.getFailureDescription()), $.publish(n.BaseEvents.SHOW_MESSAGE, [i.UVUtils.sanitize(o)])
            }
        }, e.messages = {}, e
    }();
    t.Auth1 = s
...
define("modules/uv-dialogues-module/AuthDialogue", ["require", "exports", "../uv-shared-module/BaseEvents", "../uv-shared-module/Dialogue", "../../Utils"], function (e, t, n, i, o) {
    ...
    var r = function (e) {
        ...
        return __extends(t, e), t.prototype.create = function () {
            var t = this;
            this.setConfig("authDialogue"), e.prototype.create.call(this), this.openCommand = n.BaseEvents.SHOW_AUTH_DIALOGUE, this.closeCommand = n.BaseEvents.HIDE_AUTH_DIALOGUE, $.subscribe(this.openCommand, function (e, n) {
                t.closeCallback = n.closeCallback, t.confirmCallback = n.confirmCallback, t.cancelCallback = n.cancelCallback, t.service = n.service, t.open()
            }), $.subscribe(this.closeCommand, function () {
                t.close()
            ...
            var t = this.service.getHeader(), i = this.service.getDescription(), r = this.service.getConfirmLabel();
...
define("modules/uv-dialogues-module/ClickThroughDialogue", ["require", "exports", "../uv-shared-module/BaseEvents", "../uv-shared-module/Dialogue"], function (e, t, n, i) {
    ...
    var o = function (e) {
        ...
        return __extends(t, e), t.prototype.create = function () {
            var t = this;
            this.setConfig("clickThroughDialogue"), e.prototype.create.call(this), this.openCommand = n.BaseEvents.SHOW_CLICKTHROUGH_DIALOGUE, this.closeCommand = n.BaseEvents.HIDE_CLICKTHROUGH_DIALOGUE, $.subscribe(this.openCommand, function (e, n) {
                ...
                e.preventDefault(), t.close(), $.publish(n.BaseEvents.ACCEPT_TERMS), t.acceptCallback && t.acceptCallback()
            })
        }, t.prototype.open = function () {
...
define("modules/uv-dialogues-module/LoginDialogue", ["require", "exports", "../uv-shared-module/BaseEvents", "../uv-shared-module/Dialogue"], function (e, t, n, i) {
    ...
    var o = function (e) {
        ...
        return __extends(t, e), t.prototype.create = function () {
            var t = this;
            this.setConfig("loginDialogue"), e.prototype.create.call(this), this.openCommand = n.BaseEvents.SHOW_LOGIN_DIALOGUE, this.closeCommand = n.BaseEvents.HIDE_LOGIN_DIALOGUE, $.subscribe(this.openCommand, function (e, n) {
                t.loginCallback = n.loginCallback, t.logoutCallback = n.logoutCallback, t.options = n.options, t.resource = n.resource, t.open()
            }), $.subscribe(this.closeCommand, function () {
                t.close()
            ...
            e.prototype.open.call(this);
            var t = "";
            this.resource.loginService && (this.$title.text(this.resource.loginService.getProperty("label")), t = this.resource.loginService.getProperty("description")), this.options.warningMessage && (t = '<span class="warning">' + this.extension.data.config.content[this.options.warningMessage] + '</span><span class="description">' + t + "</span>"),
                this.updateLogoutButton(), this.$message.html(t), this.$message.targetBlank(), this.$message.find("a").on("click", function () {
                var e = $(this).attr("href");
                $.publish(n.BaseEvents.EXTERNAL_LINK_CLICKED, [e])
...
define("modules/uv-dialogues-module/RestrictedDialogue", ["require", "exports", "../uv-shared-module/BaseEvents", "../uv-shared-module/Dialogue"], function (e, t, n, i) {
    ...
    var o = function (e) {
        ...
        return __extends(t, e), t.prototype.create = function () {
            var t = this;
            this.setConfig("restrictedDialogue"), e.prototype.create.call(this), this.openCommand = n.BaseEvents.SHOW_RESTRICTED_DIALOGUE, this.closeCommand = n.BaseEvents.HIDE_RESTRICTED_DIALOGUE, $.subscribe(this.openCommand, function (e, n) {
                t.acceptCallback = n.acceptCallback, t.options = n.options, t.resource = n.resource, t.open()
            }), $.subscribe(this.closeCommand, function () {
                t.close()
    ...
    var d = function () {
        ...
        return e.prototype.create = function () {
            var e = this, t = this;
            if (this.$element = $(this.component.options.target), this.$element.data("component", this.component), this.fire(s.BaseEvents.CREATE, {
                data: this.data,
                ...
                Utils.Bools.getBool(this.data.config.options.dropEnabled, !0) && this.$element.on("drop", function (t) {
                    t.preventDefault();
                    var n = t.originalEvent.dataTransfer.getData("URL"), i = Utils.Urls.getUrlParts(n),
                    ...
                    var n = null, i = !0;
                    e.ctrlKey || e.altKey || e.shiftKey || (e.keyCode === KeyCodes.KeyDown.Enter && (n = s.BaseEvents.RETURN, i = !1), e.keyCode === KeyCodes.KeyDown.Escape && (n = s.BaseEvents.ESCAPE), e.keyCode === KeyCodes.KeyDown.PageUp && (n = s.BaseEvents.PAGE_UP), e.keyCode === KeyCodes.KeyDown.PageDown && (n = s.BaseEvents.PAGE_DOWN), e.keyCode === KeyCodes.KeyDown.End && (n = s.BaseEvents.END), e.keyCode === KeyCodes.KeyDown.Home && (n = s.BaseEvents.HOME), (e.keyCode === KeyCodes.KeyDown.NumpadPlus || 171 === e.keyCode || e.keyCode === KeyCodes.KeyDown.Equals) && (n = s.BaseEvents.PLUS, i = !1), (e.keyCode === KeyCodes.KeyDown.NumpadMinus || 173 === e.keyCode || e.keyCode === KeyCodes.KeyDown.Dash) && (n = s.BaseEvents.MINUS, i = !1), t.useArrowKeysToNavigate() && (e.keyCode === KeyCodes.KeyDown.LeftArrow && (n = s.BaseEvents.LEFT_ARROW), e.keyCode === KeyCodes.KeyDown.UpArrow && (n = s.BaseEvents.UP_ARROW), e.keyCode === KeyCodes.KeyDown.RightArrow && (n = s.BaseEvents.RIGHT_ARROW), e.keyCode === KeyCodes.KeyDown.DownArrow && (n = s.BaseEvents.DOWN_ARROW))), n && (i && e.preventDefault(), $.publish(n))
                })
            }
            $.subscribe(s.BaseEvents.EXIT_FULLSCREEN, function () {
                e.isOverlayActive() && $.publish(s.BaseEvents.ESCAPE), $.publish(s.BaseEvents.ESCAPE), $.publish(s.BaseEvents.RESIZE)
            }), this.$element.append('<a href="/" id="top"></a>'), this.$element.append('<iframe id="commsFrame" style="display:none"></iframe>'), this.$element.append('<div id="debug"><span id="watch">Watch</span><span id="mobile-portrait">Mobile Portrait</span><span id="mobile-landscape">Mobile Landscape</span><span id="desktop">Desktop</span></div>'), $.subscribe(s.BaseEvents.ACCEPT_TERMS, function () {
                ...
                e.data.canvasIndex = n, e.lastCanvasIndex = e.helper.canvasIndex, e.helper.canvasIndex = n, e.fire(s.BaseEvents.CANVAS_INDEX_CHANGED, e.data.canvasIndex)
                ...
                e.data.collectionIndex = n, e.fire(s.BaseEvents.COLLECTION_INDEX_CHANGED, e.data.collectionIndex)
                ...
                e.fire(s.BaseEvents.ESCAPE), e.isFullScreen() && !e.isOverlayActive() && $.publish(s.BaseEvents.TOGGLE_FULLSCREEN)
                ...
                e.fire(s.BaseEvents.LOAD_FAILED), null == !t.lastCanvasIndex && t.lastCanvasIndex !== t.helper.canvasIndex && $.publish(s.BaseEvents.CANVAS_INDEX_CHANGED, [t.lastCanvasIndex])
            }), $.subscribe(s.BaseEvents.MANIFEST_INDEX_CHANGED, function (t, n) {
                e.data.manifestIndex = n, e.fire(s.BaseEvents.MANIFEST_INDEX_CHANGED, e.data.manifestIndex)
                ...
                n ? (e.data.rangeId = n.id, e.helper.rangeId = n.id, e.fire(s.BaseEvents.RANGE_CHANGED, e.data.rangeId)) : (e.data.rangeId = void 0, e.helper.rangeId = null, e.fire(s.BaseEvents.RANGE_CHANGED, null))
                ...
                e.data.sequenceIndex = n, e.fire(s.BaseEvents.SEQUENCE_INDEX_CHANGED, e.data.sequenceIndex)
            ...
            i.length ? e(null) : requirejs([n], function (n) {
                var i = t.helper.getCurrentCanvas(), o = t.getMediaFormats(i), r = [];
                o && o.length && (r = o.map(function (e) {
                    return e.getFormat().toString()
                }));
                var s = n(r), a = t.data.root + "/lib/";
                if (s.sync) for (var u = 0; u < s.sync.length; u++) {
                    var l = s.sync[u];
                    l.startsWith("!") || (s.sync[u] = a + l)
                }
                if (s.async) for (var u = 0; u < s.async.length; u++) {
                    var l = s.async[u];
            ...
            this.createModules(), this.modulesCreated(), $.publish(s.BaseEvents.RESIZE), setTimeout(function () {
                e.render(), $.publish(s.BaseEvents.CREATED), e._setDefaultFocus()
            }, 1)
        }, e.prototype.render = function () {
            if (this.isCreated && this.data.collectionIndex === this.helper.collectionIndex || $.publish(s.BaseEvents.COLLECTION_INDEX_CHANGED, [this.data.collectionIndex]), this.isCreated && this.data.manifestIndex === this.helper.manifestIndex || $.publish(s.BaseEvents.MANIFEST_INDEX_CHANGED, [this.data.manifestIndex]), this.isCreated && this.data.sequenceIndex === this.helper.sequenceIndex || $.publish(s.BaseEvents.SEQUENCE_INDEX_CHANGED, [this.data.sequenceIndex]), this.isCreated && this.data.canvasIndex === this.helper.canvasIndex || $.publish(s.BaseEvents.CANVAS_INDEX_CHANGED, [this.data.canvasIndex]), (!this.isCreated || this.data.rangeId !== this.helper.rangeId) && this.data.rangeId) {
                var e = this.helper.getRangeById(this.data.rangeId);
                e ? $.publish(s.BaseEvents.RANGE_CHANGED, [e]) : console.warn("range id not found:", this.data.rangeId)
            }
            ...
            var e = this.data.config.localisation.locales.slice(0), t = this.data.locales, n = [];
            if (t) {
            ...
            setTimeout(function () {
                for (var t = !1, n = 0; n < e.metrics.length; n++) {
                    var i = e.metrics[n];
                    e.width() >= i.minWidth && e.width() <= i.maxWidth && e.height() >= i.minHeight && e.height() <= i.maxHeight && (t = !0, e.metric !== i.type && (e.metric = i.type, $.publish(s.BaseEvents.METRIC_CHANGED)))
                }
                t || e.metric !== l.MetricType.NONE && (e.metric = l.MetricType.NONE, $.publish(s.BaseEvents.METRIC_CHANGED))
            }, 1)
        }, e.prototype.resize = function () {
            ...
            var o = t + i, r = "";
            return Utils.Documents.isInIFrame() || (r = this.data.root || "", r.startsWith("./") && (r = r.substr(2)), r && !r.endsWith("/") && (r += "/")), n.UVUtils.isValidUrl(r) ? r + "uv.html" : o + r + "uv.html"
            ...
            var e = this.helper.getLabel(), t = this.helper.getCurrentCanvas(), n = t.getProperty("thumbnail");
            ...
            for (var e = this.getPagedIndices(this.helper.canvasIndex), t = [], n = 0; n < e.length; n++) {
                var i = e[n], o = this.helper.getCanvasByIndex(i);
                t.push(o)
            }
            return t
        }, e.prototype.getCanvasLabels = function (e) {
            var t = this.getPagedIndices(), n = "";
            if (1 === t.length) n = e; else for (var i = 1; i <= t.length; i++) n.length && (n += ","), n += e + " " + i;
            return n
            ...
            var t = this, n = this.getPagedIndices(), r = [];
            n.forEach(function (n) {
                var i, o = t.helper.getCanvasByIndex(n);
                if (i = o.externalResource ? o.externalResource : new Manifold.ExternalResource(o, {authApiVersion: t.data.config.options.authAPIVersion}), e) {
            ...
            var s = this.data.config.options.tokenStorage, a = this.data.config.options.authAPIVersion;
            ...
            var i = {
                id: e.id, type: e.getType(), getFormat: function () {
                    return ""
                }
            };
            return [i]
        }, e.prototype.viewCanvas = function (e) {
            return this.helper.isCanvasIndexOutOfRange(e) ? void this.showMessage(this.data.config.content.canvasIndexOutOfRange) : void $.publish(s.BaseEvents.OPEN_EXTERNAL_RESOURCE)
        }, e.prototype.showMessage = function (e, t, n, i) {
            this.closeActiveDialogue(), $.publish(s.BaseEvents.SHOW_GENERIC_DIALOGUE, [{
                message: e,
                acceptCallback: t,
                buttonText: n,
                allowClose: i
            ...
            var t = {};
            t.iiifResourceUri = this.helper.iiifResourceUri, t.collectionIndex = this.helper.getCollectionIndex(e) || 0, t.manifestIndex = e.index, t.sequenceIndex = 0, t.canvasIndex = 0, this.reload(t)
        }, e.prototype.viewCollection = function (e) {
            var t = {};
            t.iiifResourceUri = this.helper.iiifResourceUri, t.collectionIndex = e.index, t.manifestIndex = 0, t.sequenceIndex = 0, t.canvasIndex = 0, this.reload(t)
...
define("modules/uv-contentleftpanel-module/GalleryView", ["require", "exports", "../uv-shared-module/BaseEvents", "../uv-shared-module/BaseView"], function (e, t, n, i) {
    ...
    var o = function (e) {
        ...
        return __extends(t, e), t.prototype.create = function () {
            ...
            this.galleryComponent = new IIIFComponents.GalleryComponent({target: this.$gallery[0]}), this.galleryComponent.on("thumbSelected", function (e) {
                $.publish(n.BaseEvents.GALLERY_THUMB_SELECTED, [e]), $.publish(n.BaseEvents.THUMB_SELECTED, [e])
            ...
            e.prototype.resize.call(this);
            var t = this.$gallery.find(".main"), n = this.$gallery.find(".header");
...
define("modules/uv-shared-module/BaseExpandPanel", ["require", "exports", "./BaseView"], function (e, t, n) {
    ...
    var i = function (e) {
        ...
        return __extends(t, e), t.prototype.create = function () {
            ...
            var t = this.getFullTargetWidth(), n = this.getFullTargetLeft();
            ...
            var e = this, t = this.getTargetWidth(), n = this.getTargetLeft();
...
define("modules/uv-shared-module/LeftPanel", ["require", "exports", "./BaseEvents", "./BaseExpandPanel"], function (e, t, n, i) {
    ...
    var o = function (e) {
        ...
        return __extends(t, e), t.prototype.create = function () {
            var t = this;
            e.prototype.create.call(this), this.$element.width(this.options.panelCollapsedWidth), $.subscribe(n.BaseEvents.TOGGLE_EXPAND_LEFT_PANEL, function () {
            ...
            e.prototype.toggleFinish.call(this), this.isExpanded ? $.publish(n.BaseEvents.OPEN_LEFT_PANEL) : $.publish(n.BaseEvents.CLOSE_LEFT_PANEL), this.extension.updateSettings({leftPanelOpen: this.isExpanded})
        }, t.prototype.resize = function () {
...
define("modules/uv-shared-module/ThumbsView", ["require", "exports", "./BaseEvents", "./BaseView"], function (e, t, n, i) {
    ...
    var o = function (e) {
        ...
        return __extends(t, e), t.prototype.create = function () {
            var t = this;
            e.prototype.create.call(this), $.subscribe(n.BaseEvents.CANVAS_INDEX_CHANGED, function (e, n) {
            ...
            if (void 0 === e && (e = this.extension.helper.canvasIndex), this.thumbs && this.thumbs.length) {
                var t, n = this.extension.helper.getCanvasByIndex(e), i = n.getContent();
                if (i.length) {
                    var o = i[0], r = o.getBody();
                    if (r.length) {
                        var s = r[0].getType();
                ...
                for (var a = e, u = this.options.thumbsLoadRange, l = {
                    ...
                    var d = this.getThumbByIndex(p), f = d.find(".wrap");
            ...
            var e = this.extension.helper.getCurrentCanvas(), t = e.getType();
...
define("modules/uv-contentleftpanel-module/ThumbsView", ["require", "exports", "../uv-shared-module/ThumbsView", "../../extensions/uv-seadragon-extension/Events", "../../extensions/uv-seadragon-extension/Mode"], function (e, t, n, i, o) {
    ...
    var r = function (e) {
        ...
        return __extends(t, e), t.prototype.create = function () {
            var t = this;
            this.setConfig("contentLeftPanel"), e.prototype.create.call(this), $.subscribe(i.Events.MODE_CHANGED, function () {
                t.setLabel()
    ...
    var o = function (e) {
        ...
        return __extends(t, e), t.prototype.create = function () {
            ...
            this.treeComponent = new IIIFComponents.TreeComponent({
                target: this.$tree[0],
                data: this.treeData
            }), this.treeComponent.on("treeNodeSelected", function (e) {
                $.publish(n.BaseEvents.TREE_NODE_SELECTED, [e])
            }, !1), this.treeComponent.on("treeNodeMultiSelected", function (e) {
...
define("modules/uv-contentleftpanel-module/ContentLeftPanel", ["require", "exports", "../uv-shared-module/BaseEvents", "./GalleryView", "../uv-shared-module/LeftPanel", "../../extensions/uv-seadragon-extension/Mode", "./ThumbsView", "./TreeView"], function (e, t, n, i, o, r, s, a) {
    ...
    var u = function (e) {
        ...
        return __extends(t, e), t.prototype.create = function () {
            var t = this;
            this.setConfig("contentLeftPanel"), e.prototype.create.call(this), $.subscribe(n.BaseEvents.SETTINGS_CHANGED, function () {
                t.databind()
            ...
            if (e.length > 1) for (var t = 0; t < e.length; t++) {
                var n = e[t];
            ...
            var e = null, t = this.extension.helper.getTopRanges();
            ...
            if (this.thumbsView) {
                var e, t, n = this.getViewingHint(), i = this.getViewingDirection();
                ...
                if (r && r.length) for (var s = function (e) {
                    var t = r[e], n = o.en().where(function (e) {
            ...
            if (e.prototype.toggleFinish.call(this), this.isUnopened) {
                var t = Utils.Bools.getBool(this.config.options.treeEnabled, !0),
                    n = Utils.Bools.getBool(this.config.options.thumbsEnabled, !0), i = this.getTree();
            ...
            var e = Utils.Bools.getBool(this.config.options.defaultToTreeEnabled, !1),
                t = this.config.options.defaultToTreeIfGreaterThan || 0, n = this.getTree();
            return e && n && n.nodes.length > t ? !1 : !0
        }, t.prototype.expandFullStart = function () {
            e.prototype.expandFullStart.call(this), $.publish(n.BaseEvents.LEFTPANEL_EXPAND_FULL_START)
        }, t.prototype.expandFullFinish = function () {
            e.prototype.expandFullFinish.call(this), this.$treeButton.hasClass("on") ? this.openTreeView() : this.$thumbsButton.hasClass("on") && this.openThumbsView(), $.publish(n.BaseEvents.LEFTPANEL_EXPAND_FULL_FINISH)
        }, t.prototype.collapseFullStart = function () {
            e.prototype.collapseFullStart.call(this), $.publish(n.BaseEvents.LEFTPANEL_COLLAPSE_FULL_START)
        }, t.prototype.collapseFullFinish = function () {
            e.prototype.collapseFullFinish.call(this), this.$thumbsButton.hasClass("on") && this.openThumbsView(), $.publish(n.BaseEvents.LEFTPANEL_COLLAPSE_FULL_FINISH)
        }, t.prototype.openTreeView = function () {
            this.isTreeViewOpen = !0, this.isThumbsViewOpen = !1, this.treeView || this.createTreeView(), this.$treeButton.addClass("on"), this.$thumbsButton.removeClass("on"), this.treeView.show(), this.thumbsView && this.thumbsView.hide(), this.galleryView && this.galleryView.hide(), this.updateTreeViewOptions(), this.selectCurrentTreeNode(), this.resize(), this.treeView.resize(), $.publish(n.BaseEvents.OPEN_TREE_VIEW)
        }, t.prototype.openThumbsView = function () {
            this.isTreeViewOpen = !1, this.isThumbsViewOpen = !0, this.thumbsView || this.createThumbsView(), this.isFullyExpanded && !this.galleryView && this.createGalleryView(), this.$treeButton.removeClass("on"), this.$thumbsButton.addClass("on"), this.treeView && this.treeView.hide(), this.$treeSelect.hide(), this.$treeViewOptions.hide(), this.resize(), this.isFullyExpanded ? (this.thumbsView.hide(), this.galleryView && this.galleryView.show(), this.galleryView && this.galleryView.resize()) : (this.galleryView && this.galleryView.hide(), this.thumbsView.show(), this.thumbsView.resize()), $.publish(n.BaseEvents.OPEN_THUMBS_VIEW)
            ...
            var e = -1, t = this.extension.getCurrentCanvasRange();
            ...
            if (this.treeView) {
                var e = this.extension.helper.getCurrentRange(), t = null;
                e && e.treeNode && (t = this.treeView.getNodeById(e.treeNode.id)), t ? this.treeView.selectNode(t) : this.treeView.deselectCurrentNode()
            }
        }, t.prototype.selectCurrentTreeNodeByCanvas = function () {
            if (this.treeView) {
                var e = null, t = this.getCurrentCanvasTopRangeIndex(), n = this.getSelectedTopRangeIndex(),
                    i = t === n, o = null;
                -1 !== t && (o = this.extension.getCurrentCanvasRange(), o && o.treeNode && (e = this.treeView.getNodeById(o.treeNode.id))), e && i ? this.treeView.selectNode(e) : (o = this.extension.helper.getCurrentRange(), o && o.treeNode && (e = this.treeView.getNodeById(o.treeNode.id)), e ? this.treeView.selectNode(e) : this.treeView.deselectCurrentNode())
            }
        }, t.prototype.resize = function () {
...
define("modules/uv-dialogues-module/DownloadDialogue", ["require", "exports", "../uv-shared-module/BaseEvents", "../uv-shared-module/Dialogue", "../uv-shared-module/DownloadOption"], function (e, t, n, i, o) {
    ...
    var r = function (e) {
        ...
        return __extends(t, e), t.prototype.create = function () {
            var t = this;
            this.setConfig("downloadDialogue"), e.prototype.create.call(this), this.openCommand = n.BaseEvents.SHOW_DOWNLOAD_DIALOGUE, this.closeCommand = n.BaseEvents.HIDE_DOWNLOAD_DIALOGUE, $.subscribe(this.openCommand, function (e, n) {
                t.open(n)
            }), $.subscribe(this.closeCommand, function () {
                t.close()
            ...
            switch (e) {
                case o.DownloadOption.ENTIRE_FILE_AS_ORIGINAL:
                    var t = this.extension.helper.manifest.getService(manifesto.ServiceProfile.uiExtensions());
...
define("extensions/uv-av-extension/DownloadDialogue", ["require", "exports", "../../modules/uv-dialogues-module/DownloadDialogue", "../../modules/uv-shared-module/DownloadOption", "../../modules/uv-shared-module/BaseEvents"], function (e, t, n, i, o) {
    ...
    var r = function (e) {
        ...
        return __extends(t, e), t.prototype.create = function () {
            var t = this;
            this.setConfig("downloadDialogue"), e.prototype.create.call(this), this.$entireFileAsOriginal = $('<li class="option single"><input id="' + i.DownloadOption.ENTIRE_FILE_AS_ORIGINAL + '" type="radio" name="downloadOptions" tabindex="0" /><label id="' + i.DownloadOption.ENTIRE_FILE_AS_ORIGINAL + 'label" for="' + i.DownloadOption.ENTIRE_FILE_AS_ORIGINAL + '"></label></li>'), this.$downloadOptions.append(this.$entireFileAsOriginal), this.$entireFileAsOriginal.hide(), this.$downloadButton = $('<a class="btn btn-primary" href="#" tabindex="0">' + this.content.download + "</a>"), this.$buttons.prepend(this.$downloadButton);
            var n = this;
            this.$downloadButton.on("click", function (e) {
                e.preventDefault();
                var r = n.getSelectedOption(), s = r.attr("id"), a = r.attr("title"), u = i.DownloadOption.UNKNOWN;
                if (t.renderingUrls[s]) window.open(t.renderingUrls[s]); else {
                    var l = t.getCurrentResourceId();
                    window.open(l)
                }
                $.publish(o.BaseEvents.DOWNLOAD, [{type: u, label: a}]), t.close()
            })
        }, t.prototype._isAdaptive = function () {
            var e = this.getCurrentResourceFormat();
            return "mpd" === e || "m3u8" === e
        }, t.prototype.open = function (t) {
            if (e.prototype.open.call(this, t), this.isDownloadOptionAvailable(i.DownloadOption.ENTIRE_FILE_AS_ORIGINAL) && !this._isAdaptive()) {
                var n = this.$entireFileAsOriginal.find("input"), o = this.$entireFileAsOriginal.find("label"),
                    r = Utils.Strings.format(this.content.entireFileAsOriginalWithFormat, this.getCurrentResourceFormat());
                o.text(r), n.prop("title", r), this.$entireFileAsOriginal.show()
            }
            if (this.resetDynamicDownloadOptions(), this.isDownloadOptionAvailable(i.DownloadOption.RANGE_RENDERINGS)) {
                var s = this.extension.helper.getCurrentRange();
                if (s) {
                    var a = this.getDownloadOptionsForRenderings(s, this.content.entireFileAsOriginal, i.DownloadOption.CANVAS_RENDERINGS);
                    this.addDownloadOptionsForRenderings(a)
                }
            }
            this.$downloadOptions.find("li.option:visible").length ? (this.$downloadOptions.find("li.option input:visible:first").prop("checked", !0), this.$noneAvailable.hide(), this.$downloadButton.show()) : (this.$noneAvailable.show(), this.$downloadButton.hide()), this.resize()
...
define("modules/uv-shared-module/FooterPanel", ["require", "exports", "./BaseEvents", "./BaseView"], function (e, t, n, i) {
    ...
    var o = function (e) {
        ...
        return __extends(t, e), t.prototype.create = function () {
            var t = this;
            this.setConfig("footerPanel"), e.prototype.create.call(this), $.subscribe(n.BaseEvents.TOGGLE_FULLSCREEN, function () {
        ...
        return e.prototype.Get = function (e) {
            switch (e.informationType) {
                ...
                case r.InformationType.DEGRADED_RESOURCE:
                    var t = [], s = new o.InformationAction, a = e.param.loginService.getConfirmLabel();
                    a || (a = this.extension.data.config.content.fallbackDegradedLabel), s.label = a;
                    var u = e.param;
                    s.action = function () {
                        u.authHoldingPage = window.open("", "_blank"), $.publish(n.BaseEvents.HIDE_INFORMATION), $.publish(n.BaseEvents.OPEN_EXTERNAL_RESOURCE, [[u]])
                    }, t.push(s);
                    var l = e.param.loginService.getServiceLabel();
                    return l || (l = this.extension.data.config.content.fallbackDegradedMessage), new i.Information(l, t)
            }
        }, e
    }();
...
define("modules/uv-shared-module/HeaderPanel", ["require", "exports", "./BaseEvents", "./BaseView", "../uv-shared-module/InformationFactory"], function (e, t, n, i, o) {
    ...
    var r = function (e) {
        ...
        return __extends(t, e), t.prototype.create = function () {
            var t = this;
            this.setConfig("headerPanel"), e.prototype.create.call(this), $.subscribe(n.BaseEvents.SHOW_INFORMATION, function (e, n) {
                t.showInformation(n)
            ...
            var e = this.extension.getAlternateLocale(), t = e.name.split("-")[0].toUpperCase();
            ...
            for (var r = 0; r < this.information.actions.length; r++) {
                var s = this.information.actions[r], a = $('<a href="#" class="btn btn-default">' + s.label + "</a>");
            ...
            e.prototype.resize.call(this);
            var t = this.$element.width(), n = t / 2, i = this.$centerOptions.outerWidth(), o = n - i / 2;
            if (this.$centerOptions.css({left: o}), this.$informationBox.is(":visible")) {
                var r = this.$informationBox.find(".actions"), s = this.$informationBox.find(".message");
...
define("modules/uv-shared-module/RightPanel", ["require", "exports", "./BaseEvents", "./BaseExpandPanel"], function (e, t, n, i) {
    ...
    var o = function (e) {
        ...
        return __extends(t, e), t.prototype.create = function () {
            ...
            i && this.toggle(!0), $.subscribe(n.BaseEvents.TOGGLE_EXPAND_RIGHT_PANEL, function () {
                t.isFullyExpanded ? t.collapseFull() : t.expandFull()
            })
        }, t.prototype.getTargetWidth = function () {
            ...
            e.prototype.toggleFinish.call(this), this.isExpanded ? $.publish(n.BaseEvents.OPEN_RIGHT_PANEL) : $.publish(n.BaseEvents.CLOSE_RIGHT_PANEL), this.extension.updateSettings({rightPanelOpen: this.isExpanded})
        }, t.prototype.resize = function () {
            e.prototype.resize.call(this), this.$element.css({left: Math.floor(this.$element.parent().width() - this.$element.outerWidth())})
        }, t
    }(i.BaseExpandPanel);
    t.RightPanel = o
});
...
define("modules/uv-moreinforightpanel-module/MoreInfoRightPanel", ["require", "exports", "../uv-shared-module/BaseEvents", "../uv-shared-module/RightPanel", "../../Utils"], function (e, t, n, i, o) {
    ...
    var r = function (e) {
        ...
        return __extends(t, e), t.prototype.create = function () {
            var t = this;
            this.setConfig("moreInfoRightPanel"), e.prototype.create.call(this), $.subscribe(n.BaseEvents.CANVAS_INDEX_CHANGED, function () {
                t.databind()
            }), $.subscribe(n.BaseEvents.RANGE_CHANGED, function () {
                t.databind()
...
define("modules/uv-dialogues-module/SettingsDialogue", ["require", "exports", "../uv-shared-module/BaseEvents", "../uv-shared-module/Dialogue"], function (e, t, n, i) {
    ...
    var o = function (e) {
        ...
        return __extends(t, e), t.prototype.create = function () {
            var t = this;
            this.setConfig("settingsDialogue"), e.prototype.create.call(this), this.openCommand = n.BaseEvents.SHOW_SETTINGS_DIALOGUE, this.closeCommand = n.BaseEvents.HIDE_SETTINGS_DIALOGUE, $.subscribe(this.openCommand, function () {
                t.open()
            }), $.subscribe(this.closeCommand, function () {
                t.close()
            ...
            var t = this;
            e.prototype.open.call(this), $.getJSON(this.extension.data.root + "/info.json", function (e) {
                t.$version.text("v" + e.version)
            })
        }, t.prototype._createLocalesMenu = function () {
            var e = this, t = this.extension.data.locales;
            if (t && t.length > 1) {
                for (var n = 0; n < t.length; n++) {
                    var i = t[n];
...
define("modules/uv-dialogues-module/ShareDialogue", ["require", "exports", "../uv-shared-module/BaseEvents", "../uv-shared-module/Dialogue"], function (e, t, n, i) {
    ...
    var o = function (e) {
        function t(t) {
            var n = e.call(this, t) || this;
            return n.aspectRatio = .75, n.isEmbedViewVisible = !1, n.isShareViewVisible = !1, n.maxWidth = 8e3, n.maxHeight = n.maxWidth * n.aspectRatio, n.minWidth = 200, n.minHeight = n.minWidth * n.aspectRatio, n
        }

        return __extends(t, e), t.prototype.create = function () {
            var t = this;
            this.setConfig("shareDialogue"), e.prototype.create.call(this), this.openCommand = n.BaseEvents.SHOW_SHARE_DIALOGUE, this.closeCommand = n.BaseEvents.HIDE_SHARE_DIALOGUE, $.subscribe(this.openCommand, function (e, n) {
...
define("extensions/uv-av-extension/Extension", ["require", "exports", "../../modules/uv-avcenterpanel-module/AVCenterPanel", "../../modules/uv-shared-module/BaseEvents", "../../modules/uv-shared-module/BaseExtension", "../../modules/uv-contentleftpanel-module/ContentLeftPanel", "./DownloadDialogue", "../../modules/uv-shared-module/FooterPanel", "../../modules/uv-avmobilefooterpanel-module/MobileFooter", "../../modules/uv-shared-module/HeaderPanel", "../../modules/uv-moreinforightpanel-module/MoreInfoRightPanel", "./SettingsDialogue", "./ShareDialogue", "../../modules/uv-shared-module/Shell"], function (e, t, n, i, o, r, s, a, u, l, c, h, p, d) {
    ...
    var f = function (e) {
        ...
        return __extends(t, e), t.prototype.create = function () {
            var t = this;
            e.prototype.create.call(this), $.subscribe(i.BaseEvents.CANVAS_INDEX_CHANGED, function (e, n) {
                t.viewCanvas(n)
            ...
            var t = e.prototype.isLeftPanelEnabled.call(this), n = this.helper.getTree();
            return n && n.nodes.length && (t = !0), t
        }, t.prototype.render = function () {
            e.prototype.render.call(this)
        }, t.prototype.getEmbedScript = function (e, t, n) {
            var i = this.getAppUri(),
                o = i + "#?manifest=" + this.helper.iiifResourceUri + "&c=" + this.helper.collectionIndex + "&m=" + this.helper.manifestIndex + "&s=" + this.helper.sequenceIndex + "&cv=" + this.helper.canvasIndex + "&rid=" + this.helper.rangeId,
...
define("modules/uv-filelinkcenterpanel-module/FileLinkCenterPanel", ["require", "exports", "../uv-shared-module/BaseEvents", "../uv-shared-module/CenterPanel", "../../Utils"], function (e, t, n, i, o) {
    ...
    var r = function (e) {
        ...
        return __extends(t, e), t.prototype.create = function () {
            var t = this;
            this.setConfig("fileLinkCenterPanel"), e.prototype.create.call(this), $.subscribe(n.BaseEvents.OPEN_EXTERNAL_RESOURCE, function (e, n) {
                t.openMedia(n)
            ...
            this.extension.getExternalResources(e).then(function () {
                for (var e, n = t.extension.helper.getCurrentCanvas(), i = n.getContent(), r = 0; r < i.length; r++) {
                    ...
                    if (s.getBody().length) {
                        ...
                        var a = e.find(".filename"), u = e.find(".label"), l = e.find("img"),
                            c = e.find(".description"), h = s.getBody()[0], p = h.getProperty("id");
...
define("modules/uv-dialogues-module/HelpDialogue", ["require", "exports", "../uv-shared-module/BaseEvents", "../uv-shared-module/Dialogue"], function (e, t, n, i) {
    ...
    var o = function (e) {
        ...
        return __extends(t, e), t.prototype.create = function () {
            var t = this;
            this.setConfig("helpDialogue"), e.prototype.create.call(this), this.openCommand = n.BaseEvents.SHOW_HELP_DIALOGUE, this.closeCommand = n.BaseEvents.HIDE_HELP_DIALOGUE, $.subscribe(this.openCommand, function () {
                t.open()
            }), $.subscribe(this.closeCommand, function () {
                t.close()
...
define("modules/uv-resourcesleftpanel-module/ResourcesLeftPanel", ["require", "exports", "../uv-shared-module/BaseEvents", "../uv-shared-module/LeftPanel", "./ThumbsView"], function (e, t, n, i, o) {
    ...
    var r = function (e) {
        ...
        return __extends(t, e), t.prototype.create = function () {
            ...
            e.prototype.expandFullFinish.call(this), $.publish(n.BaseEvents.LEFTPANEL_EXPAND_FULL_FINISH)
        }, t.prototype.collapseFullStart = function () {
            e.prototype.collapseFullStart.call(this), $.publish(n.BaseEvents.LEFTPANEL_COLLAPSE_FULL_START)
        }, t.prototype.collapseFullFinish = function () {
            e.prototype.collapseFullFinish.call(this), $.publish(n.BaseEvents.LEFTPANEL_COLLAPSE_FULL_FINISH)
        }, t.prototype.resize = function () {
...
define("modules/uv-mediaelementcenterpanel-module/MediaElementCenterPanel", ["require", "exports", "../uv-shared-module/BaseEvents", "../../extensions/uv-mediaelement-extension/Events", "../uv-shared-module/CenterPanel", "../../Utils"], function (e, t, n, i, o, r) {
    ...
    var s = function (e) {
        ...
        return __extends(t, e), t.prototype.create = function () {
            ...
            var t = this;
            this.isVideo() && $.subscribe(n.BaseEvents.TOGGLE_FULLSCREEN, function () {
            ...
            this.extension.getExternalResources(e).then(function () {
                ...
                var o = t.extension.getPosterImageUri(), r = [], s = e.getRenderings();
                ...
                t.isVideo() ? (t.$media = $('<video controls="controls" preload="none"></video>'), t.$container.append(t.$media), t.player = new MediaElementPlayer($("video")[0], {
                    ...
                    success: function (e, t) {
                        e.addEventListener("canplay", function () {
                            ...
                            Math.floor(e.currentTime) != Math.floor(e.duration) && $.publish(i.Events.MEDIA_PAUSED, [Math.floor(e.currentTime)])
            ...
            if (e.prototype.resize.call(this), "Firefox" === window.browserDetect.browser && window.browserDetect.version < 13) this.$container.width(this.mediaWidth), this.$container.height(this.mediaHeight); else {
...
define("extensions/uv-mediaelement-extension/Extension", ["require", "exports", "../../modules/uv-shared-module/BaseEvents", "../../modules/uv-shared-module/BaseExtension", "../../modules/uv-shared-module/Bookmark", "./DownloadDialogue", "./Events", "../../modules/uv-shared-module/FooterPanel", "../../modules/uv-shared-module/HeaderPanel", "../../modules/uv-dialogues-module/HelpDialogue", "../../modules/uv-mediaelementcenterpanel-module/MediaElementCenterPanel", "../../modules/uv-moreinforightpanel-module/MoreInfoRightPanel", "../../modules/uv-resourcesleftpanel-module/ResourcesLeftPanel", "./SettingsDialogue", "./ShareDialogue", "../../modules/uv-shared-module/Shell"], function (e, t, n, i, o, r, s, a, u, l, c, h, p, d, f, g) {
    ...
    var v = function (e) {
        ...
        return __extends(t, e), t.prototype.create = function () {
            ...
            e.prototype.createModules.call(this), this.isHeaderPanelEnabled() ? this.headerPanel = new u.HeaderPanel(g.Shell.$headerPanel) : g.Shell.$headerPanel.hide(), this.isLeftPanelEnabled() && (this.leftPanel = new p.ResourcesLeftPanel(g.Shell.$leftPanel)), this.centerPanel = new c.MediaElementCenterPanel(g.Shell.$centerPanel), this.isRightPanelEnabled() && (this.rightPanel = new h.MoreInfoRightPanel(g.Shell.$rightPanel)), this.isFooterPanelEnabled() ? this.footerPanel = new a.FooterPanel(g.Shell.$footerPanel) : g.Shell.$footerPanel.hide(), this.$helpDialogue = $('<div class="overlay help" aria-hidden="true"></div>'), g.Shell.$overlays.append(this.$helpDialogue), this.helpDialogue = new l.HelpDialogue(this.$helpDialogue), this.$downloadDialogue = $('<div class="overlay download" aria-hidden="true"></div>'), g.Shell.$overlays.append(this.$downloadDialogue), this.downloadDialogue = new r.DownloadDialogue(this.$downloadDialogue), this.$shareDialogue = $('<div class="overlay share" aria-hidden="true"></div>'), g.Shell.$overlays.append(this.$shareDialogue), this.shareDialogue = new f.ShareDialogue(this.$shareDialogue), this.$settingsDialogue = $('<div class="overlay settings" aria-hidden="true"></div>'), g.Shell.$overlays.append(this.$settingsDialogue), this.settingsDialogue = new d.SettingsDialogue(this.$settingsDialogue), this.isLeftPanelEnabled() && this.leftPanel.init(), this.isRightPanelEnabled() && this.rightPanel.init()
        }, t.prototype.render = function () {
            e.prototype.render.call(this)
        }, t.prototype.isLeftPanelEnabled = function () {
            return Utils.Bools.getBool(this.data.config.options.leftPanelEnabled, !0) && (this.helper.isMultiCanvas() || this.helper.isMultiSequence() || this.helper.hasResources())
            ...
            var t = this.extensions.helper.getCurrentCanvas(), i = new o.Bookmark;
            ...
            var e = this.helper.getCurrentCanvas(), t = e.getContent();
            ...
            var e = this.helper.getCurrentCanvas(), t = e.getContent();
            if (t && t.length) for (var n = this.getMediaFormats(e), i = 0; i < n.length; i++) {
                var o = n[i], r = o.getFormat();
...
define("extensions/uv-seadragon-extension/DownloadDialogue", ["require", "exports", "../../modules/uv-shared-module/BaseEvents", "../../modules/uv-dialogues-module/DownloadDialogue", "../../modules/uv-shared-module/DownloadOption"], function (e, t, n, i, o) {
    "use strict";
    Object.defineProperty(t, "__esModule", {value: !0});
    var r = Manifesto.Size, s = function (e) {
        function t(t) {
            return e.call(this, t) || this
        }
        ...
        return __extends(t, e), t.prototype.create = function () {
            ...
            this.$downloadButton.on("click", function (e) {
                e.preventDefault();
                var r = i.getSelectedOption(), s = r.attr("id"), a = r.attr("title"), u = r.data("mime"),
                    l = o.DownloadOption.UNKNOWN, c = t.extension.helper.getCurrentCanvas();
                if (t.renderingUrls[s]) u && (-1 !== u.toLowerCase().indexOf("pdf") ? l = o.DownloadOption.ENTIRE_DOCUMENT_AS_PDF : -1 !== u.toLowerCase().indexOf("txt") && (l = o.DownloadOption.ENTIRE_DOCUMENT_AS_TEXT)), (l = o.DownloadOption.ENTIRE_DOCUMENT_AS_PDF) && window.open(t.renderingUrls[s]); else switch (l = s) {
                ...
                $.publish(n.BaseEvents.DOWNLOAD, [{type: l, label: a}]), t.close()
            }), this.$settingsButton.onPressed(function () {
                $.publish(n.BaseEvents.HIDE_DOWNLOAD_DIALOGUE), $.publish(n.BaseEvents.SHOW_SETTINGS_DIALOGUE)
            })
        }, t.prototype.open = function (t) {
            e.prototype.open.call(this, t);
            var n = this.extension.helper.getCurrentCanvas(), i = this.extension.getViewerRotation(), r = i % 180 == 0;
            if (this.isDownloadOptionAvailable(o.DownloadOption.CURRENT_VIEW)) {
                var s = this.$currentViewAsJpgButton.find("input"), a = this.$currentViewAsJpgButton.find("label"),
                    u = this.content.currentViewAsJpg, l = this.extension.getViewer(),
            ...
            if (this.isDownloadOptionAvailable(o.DownloadOption.WHOLE_IMAGE_HIGH_RES)) {
                var s = this.$wholeImageHighResButton.find("input"), a = this.$wholeImageHighResButton.find("label"),
                    d = this.getCanvasMimeType(this.extension.helper.getCurrentCanvas());
                d = d ? Utils.Files.simplifyMimeType(d) : "jpg"; // Default to jpg instead of "?"
            ...
            if (this.isDownloadOptionAvailable(o.DownloadOption.WHOLE_IMAGES_HIGH_RES)) {
                var s = this.$wholeImagesHighResButton.find("input"), a = this.$wholeImagesHighResButton.find("label"),
                    d = this.getCanvasMimeType(this.extension.helper.getCurrentCanvas());
            ...
            if (this.isDownloadOptionAvailable(o.DownloadOption.WHOLE_IMAGE_LOW_RES)) {
                ...
                var s = this.$wholeImageLowResAsJpgButton.find("input"),
                    ...
                    // console.log(this.options.confinedImageSize);
            ...
            if (this.isDownloadOptionAvailable(o.DownloadOption.SELECTION)) {
                var s = this.$selectionButton.find("input"), a = this.$selectionButton.find("label");
            ...
            if (this.resetDynamicDownloadOptions(), this.isDownloadOptionAvailable(o.DownloadOption.RANGE_RENDERINGS) && n.ranges && n.ranges.length) for (var g = 0; g < n.ranges.length; g++) {
                var v = n.ranges[g],
            ...
            if (this.isDownloadOptionAvailable(o.DownloadOption.IMAGE_RENDERINGS)) for (var y = n.getImages(), g = 0; g < y.length; g++) {
            ...
            if (this.isDownloadOptionAvailable(o.DownloadOption.CURRENT_VIEW)) {
                var E = parseInt(this.$currentViewAsJpgButton.data("width").toString()),
                    b = parseInt(this.$currentViewAsJpgButton.data("height").toString()),
                    _ = parseInt(this.$wholeImageHighResButton.data("width").toString()),
                    w = parseInt(this.$wholeImageHighResButton.data("height").toString()), S = E / _ * 100,
                    x = b / w * 100, I = this.options.currentViewDisabledPercentage;
                S >= I && x >= I ? this.$currentViewAsJpgButton.hide() : this.$currentViewAsJpgButton.show()
            }
            ...
            if (t) {
                var n = t.width, i = e.getCanonicalImageUri(n);
                if (e.externalResource && e.externalResource.hasServiceDescriptor()) {
                    var o = i.split("/"), r = this.extension.getViewerRotation();
            ...
            if (e.externalResource.data) {
                var t = e.externalResource.data.width, n = e.externalResource.data.height;
                if (t && n) return new r(t, n)
            }
            return null
        }, t.prototype.getCanvasComputedDimensions = function (e) {
            var t = this.getCanvasDimensions(e), n = e.getMaxDimensions();
            if (!t) return null;
            if (!n) return t;
            if (t.width <= n.width && t.height <= n.height) return t;
            var i = n.width / t.width, o = n.height / t.height, s = Math.min(i, o);
...
define("modules/uv-dialogues-module/ExternalContentDialogue", ["require", "exports", "../uv-shared-module/BaseEvents", "../uv-shared-module/Dialogue"], function (e, t, n, i) {
    ...
    var o = function (e) {
        ...
        return __extends(t, e), t.prototype.create = function () {
            var t = this;
            this.setConfig("externalContentDialogue"), e.prototype.create.call(this), this.openCommand = n.BaseEvents.SHOW_EXTERNALCONTENT_DIALOGUE, this.closeCommand = n.BaseEvents.HIDE_EXTERNALCONTENT_DIALOGUE, $.subscribe(this.openCommand, function (e, n) {
    ...
    var n = function () {
        function e(e, t, n, i, o, r, s, a) {
            ...
            this._$element.on("keydown", function (e) {
                var t = e.originalEvent, n = Utils.Keyboard.getCharCode(t), i = !1;
                ...
                if (c._$searchResultsList.is(":visible") && c._results.length) if (e.keyCode === KeyCodes.KeyDown.Enter) c._searchForItem(c._getSelectedListItem()); else {
        ...
        return e.prototype._searchForWords = function (e) {
            ...
            this._positionAbove ? this._$searchResultsList.css({top: -1 * this._$searchResultsList.outerHeight(!0)}) : this._$searchResultsList.css({top: this._$element.outerHeight(!0)})
            ...
            for (var t = 0; t < this._results.length; t++) {
                var n = this._results[t], i = this._$searchResultTemplate.clone(), o = i.find("a");
...
define("modules/uv-searchfooterpanel-module/FooterPanel", ["require", "exports", "../uv-shared-module/AutoComplete", "../uv-shared-module/BaseEvents", "../../extensions/uv-seadragon-extension/Events", "../uv-shared-module/FooterPanel", "../../extensions/uv-seadragon-extension/Mode", "../../Utils"], function (e, t, n, i, o, r, s, a) {
    ...
    var u = function (e) {
        ...
        return __extends(t, e), t.prototype.create = function () {
            var t = this;
            this.setConfig("searchFooterPanel"), e.prototype.create.call(this), $.subscribe(i.BaseEvents.CANVAS_INDEX_CHANGED, function () {
                ...
                t.displaySearchResults(n.annotations, n.terms), t.setCurrentSearchResultPlacemarker(), t.updatePrevButton(), t.updateNextButton()
            ...
            this.$searchButton.on("click", function (e) {
                ...
                e.preventDefault(), t.isPreviousButtonEnabled() && $.publish(o.Events.PREV_SEARCH_RESULT)
            ...
            }), this.isSearchEnabled() || (this.$searchContainer.hide(), this.$searchPagerContainer.hide(), this.$searchResultsContainer.hide(), this.$element.addClass("min")), 1 === this.extension.helper.getTotalCanvases() && this.$searchResultsContainer.hide();
            ...
            var e = this.extension.helper.canvasIndex, t = this.getFirstSearchResultCanvasIndex(),
            ...
            var e = this.extension.helper.canvasIndex, t = this.getLastSearchResultCanvasIndex(),
                n = this.getCurrentSearchResultRectIndex();
            ...
            return this.terms = e, "" === this.terms || this.terms === this.content.enterKeyword ? void this.extension.showMessage(this.config.modules.genericDialogue.content.emptyValue, function () {
                this.$searchText.focus()
            }) : (this.$searchText.blur(), this.showSearchSpinner(), void $.publish(o.Events.SEARCH, [this.terms]))
            ...
            if (e && e.length) {
                ...
                for (var n = this.getPageLineRatio(), i = this.$line.position().top, o = this.$line.position().left, r = this, s = 0; s < e.length; s++) {
                    ...
                    var c = i - l.height(), h = o + u - l.width() / 2;
                    l.css({top: c, left: h})
                }
            }
            ...
            if (!e.placemarkerTouched) {
                ...
                var i = e.getSearchResultPlacemarkers(), r = i.index(t[0]);
                e.currentPlacemarkerIndex = n, e.$placemarkerDetails.show();
                var s = "{0} {1}";
                if (e.isPageModeEnabled()) {
                    var a = e.extension.helper.getCanvasByIndex(n), u = Manifesto.LanguageMap.getValue(a.getLabel());
                ...
                if (l) {
                    ...
                    var p = e.content.instanceFound, d = e.content.instancesFound, f = "";
                ...
                var g = t.position(), v = g.top - e.$placemarkerDetails.height(), m = g.left;
            ...
            var n = $(this), i = e.toElement || e.relatedTarget, r = $(i).closest(t.$placemarkerDetails).length;
            ...
            if (null !== this.extension.helper.canvasIndex) {
                var e = this.getPageLineRatio(), t = this.$line.position().top, n = this.$line.position().left,
                    i = this.extension.helper.canvasIndex * e, o = t, r = n + i;
            ...
            var e = this.content.displaying, t = this.extension.helper.canvasIndex;
            if (this.isPageModeEnabled()) {
                var n = this.extension.helper.getCanvasByIndex(t), i = Manifesto.LanguageMap.getValue(n.getLabel());
            ...
            if (this.isSearchEnabled()) {
                this.hideSearchSpinner(), this.positionSearchResultPlacemarkers(), this.$searchContainer.hide(), this.$searchPagerControls.css({left: 0});
                var n = this.$searchResultsInfo.find(".info"), i = n.find(".number"), o = n.find(".foundFor"),
                    r = n.find(".terms");
            ...
            this.$searchPagerControls.css({left: n - this.$searchPagerControls.width() / 2}), this.$searchOptions.css({left: n - this.$searchOptions.outerWidth() / 2})
        }, t
    }(r.FooterPanel);
    t.FooterPanel = u
});
...
define("modules/uv-dialogues-module/MoreInfoDialogue", ["require", "exports", "../uv-shared-module/BaseEvents", "../uv-shared-module/Dialogue", "../../Utils"], function (e, t, n, i, o) {
    ...
    var r = function (e) {
        ...
        return __extends(t, e), t.prototype.create = function () {
            var t = this;
            this.setConfig("moreInfoDialogue"), e.prototype.create.call(this), this.openCommand = n.BaseEvents.SHOW_MOREINFO_DIALOGUE, this.closeCommand = n.BaseEvents.HIDE_MOREINFO_DIALOGUE, $.subscribe(this.openCommand, function (e, n) {
                t.open(n)
            }), $.subscribe(this.closeCommand, function () {
                t.close()
...
define("modules/uv-multiselectdialogue-module/MultiSelectDialogue", ["require", "exports", "../../modules/uv-shared-module/BaseEvents", "../../modules/uv-shared-module/Dialogue", "../../extensions/uv-seadragon-extension/Mode"], function (e, t, n, i, o) {
    ...
    var r = function (e) {
        ...
        return __extends(t, e), t.prototype.create = function () {
            ...
            var i = this;
            this.openCommand = n.BaseEvents.SHOW_MULTISELECT_DIALOGUE, this.closeCommand = n.BaseEvents.HIDE_MULTISELECT_DIALOGUE, $.subscribe(this.openCommand, function () {
                t.open();
...
define("modules/uv-pagingheaderpanel-module/PagingHeaderPanel", ["require", "exports", "../uv-shared-module/AutoComplete", "../uv-shared-module/BaseEvents", "../../extensions/uv-seadragon-extension/Events", "../uv-shared-module/HeaderPanel", "../../extensions/uv-seadragon-extension/Mode", "../../Utils"], function (e, t, n, i, o, r, s, a) {
    ...
    var u = function (e) {
        ...
        return __extends(t, e), t.prototype.create = function () {
            var t = this;
            if (this.setConfig("pagingHeaderPanel"), e.prototype.create.call(this), $.subscribe(i.BaseEvents.CANVAS_INDEX_CHANGED, function (e, n) {
                ...
                var i = [], o = t.extension.helper.getCanvases();
                if (t.isPageModeEnabled()) for (var r = 0; r < o.length; r++) {
                    var s = o[r], a = Manifesto.LanguageMap.getValue(s.getLabel());
                ...
                t.search(e)
            }, 300, 0, Utils.Bools.getBool(this.options.autocompleteAllowWords, !1)); else if (Utils.Bools.getBool(this.options.imageSelectionBoxEnabled, !0)) {
            ...
            var t = this.extension.helper.getCanvasByIndex(e), n = null;
            if (this.isPageModeEnabled()) {
            ...
            if (!e) return this.extension.showMessage(this.content.emptyValue), void $.publish(i.BaseEvents.CANVAS_INDEX_CHANGE_FAILED);
            if (this.isPageModeEnabled()) $.publish(o.Events.PAGE_SEARCH, [e]); else {
                var t = void 0;
                if (t = this.options.autoCompleteBoxEnabled ? parseInt(this.$autoCompleteBox.val(), 10) : parseInt(this.$searchText.val(), 10), t -= 1, isNaN(t)) return this.extension.showMessage(this.extension.data.config.modules.genericDialogue.content.invalidNumber), void $.publish(i.BaseEvents.CANVAS_INDEX_CHANGE_FAILED);
                var n = this.extension.helper.getCanvasByIndex(t);
                if (!n) return this.extension.showMessage(this.extension.data.config.modules.genericDialogue.content.pageNotFound), void $.publish(i.BaseEvents.CANVAS_INDEX_CHANGE_FAILED);
...
define("modules/uv-seadragoncenterpanel-module/SeadragonCenterPanel", ["require", "exports", "../uv-shared-module/BaseEvents", "../../extensions/uv-seadragon-extension/Bounds", "../uv-shared-module/CenterPanel", "../../extensions/uv-seadragon-extension/Events", "../../Utils"], function (e, t, n, i, o, r, s) {
    ...
    var a = function (e) {
        ...
        return __extends(t, e), t.prototype.create = function () {
            var t = this;
            this.setConfig("seadragonCenterPanel"), e.prototype.create.call(this), this.$viewer = $('<div id="viewer"></div>'), this.$content.prepend(this.$viewer), $.subscribe(n.BaseEvents.ANNOTATIONS, function (e, n) {
            ...
            var e = this;
            this.$spinner = $('<div class="spinner"></div>'), this.$content.append(this.$spinner), window.openSeadragonViewer = this.viewer = OpenSeadragon({
                id: "viewer",
                ...
                gestureSettingsMouse: {clickToZoom: Utils.Bools.getBool(this.extension.data.config.options.clickToZoomEnabled, !0)},
                navImages: {
                    zoomIn: {REST: "pixel.gif", GROUP: "pixel.gif", HOVER: "pixel.gif", DOWN: "pixel.gif"},
                    zoomOut: {REST: "pixel.gif", GROUP: "pixel.gif", HOVER: "pixel.gif", DOWN: "pixel.gif"},
                    home: {REST: "pixel.gif", GROUP: "pixel.gif", HOVER: "pixel.gif", DOWN: "pixel.gif"},
                    rotateright: {REST: "pixel.gif", GROUP: "pixel.gif", HOVER: "pixel.gif", DOWN: "pixel.gif"},
                    rotateleft: {REST: "pixel.gif", GROUP: "pixel.gif", HOVER: "pixel.gif", DOWN: "pixel.gif"},
                    next: {REST: "pixel.gif", GROUP: "pixel.gif", HOVER: "pixel.gif", DOWN: "pixel.gif"},
                    previous: {REST: "pixel.gif", GROUP: "pixel.gif", HOVER: "pixel.gif", DOWN: "pixel.gif"}
                }
                ...
                e.currentBounds = e.getViewportBounds(), e.updateVisibleAnnotationRects(), $.publish(r.Events.SEADRAGON_ANIMATION_FINISH, [t])
            ...
            this.$prevButton.onPressed(function (e) {
                if (e.preventDefault(), OpenSeadragon.cancelEvent(e), i.prevButtonEnabled) switch (t.toString()) {
                    case manifesto.ViewingDirection.leftToRight().toString():
                    case manifesto.ViewingDirection.bottomToTop().toString():
                    case manifesto.ViewingDirection.topToBottom().toString():
                ...
                if (e.preventDefault(), OpenSeadragon.cancelEvent(e), i.nextButtonEnabled) switch (t.toString()) {
                    case manifesto.ViewingDirection.leftToRight().toString():
                    case manifesto.ViewingDirection.bottomToTop().toString():
                    case manifesto.ViewingDirection.topToBottom().toString():
                        $.publish(n.BaseEvents.NEXT);
            ...
            this.$spinner.show(), this.items = [], this.extension.getExternalResources(e).then(function (e) {
                ...
                for (var n = 0; n < e.length; n++) {
                    ...
                    o = i.hasServiceDescriptor ? i : {
                        ...
                        tileSource: o, x: i.x, y: i.y, width: i.width, success: function (n) {
            ...
            for (var e = this.getAnnotationsForCurrentImages(), t = 0; t < e.length; t++) for (var n = e[t], i = this.getAnnotationOverlayRects(n), o = 0; o < i.length; o++) {
                var r = i[o], a = document.createElement("div");
            ...
            var e = [], t = this.extension.annotations;
            if (!t || !t.length) return e;
            for (var n = this.extension.getPagedIndices(), i = 0; i < n.length; i++) for (var o = n[i], r = 0; r < t.length; r++) if (t[r].canvasIndex === o) {
                e.push(t[r]);
                break
            }
            return e
            ...
            for (var e = this.getAnnotationRectsForCurrentImages(), t = 0; t < e.length; t++) {
                var n = e[t], i = this.viewer.viewport.getBounds();
            ...
            if (this.extension.previousAnnotationRect = this.extension.currentAnnotationRect || e, this.extension.currentAnnotationRect = e, Utils.Bools.getBool(this.config.options.zoomToBoundsEnabled, !1)) this.fitToBounds(new i.Bounds(e.viewportX, e.viewportY, e.width, e.height), !1); else {
                var t = e.viewportX - (.5 * this.currentBounds.w - .5 * e.width),
                    o = e.viewportY - (.5 * this.currentBounds.h - .5 * e.height), r = this.currentBounds.w,
                    s = this.currentBounds.h, a = new i.Bounds(t, o, r, s);
                this.fitToBounds(a)
            }
            ...
            }).first(), i = this.extension.resources.indexOf(n), o = 0;
            i > 0 && (o = this.extension.resources[i - 1].width);
            for (var r = 0; r < e.rects.length; r++) {
                var s = e.rects[r], a = s.x + o + (i > 0 ? this.config.options.pageGap : 0), u = s.y, l = s.width,
                    c = s.height, h = new OpenSeadragon.Rect(a, u, l, c);
            ...
            if (e.prototype.resize.call(this), this.$viewer.height(this.$content.height() - this.$viewer.verticalMargins()), this.$viewer.width(this.$content.width() - this.$viewer.horizontalMargins()), this.isCreated) {
                ...
                setTimeout(function () {
                    if (t.extension.helper.isContinuous()) if (t.extension.helper.isHorizontallyAligned()) {
...
define("extensions/uv-seadragon-extension/ShareDialogue", ["require", "exports", "./Events", "../../modules/uv-dialogues-module/ShareDialogue"], function (e, t, n, i) {
    ...
    var o = function (e) {
        function t(t) {
            ...
            return $.subscribe(n.Events.SEADRAGON_OPEN, function () {
                i.update()
        ...
        return __extends(t, e), t.prototype.create = function () {
            ...
            var t = this.extension.getViewportBounds(), n = this.extension.getViewerRotation();
...
define("extensions/uv-seadragon-extension/Extension", ["require", "exports", "../../modules/uv-shared-module/AnnotationResults", "../../modules/uv-shared-module/BaseEvents", "../../modules/uv-shared-module/BaseExtension", "../../modules/uv-shared-module/Bookmark", "../../modules/uv-contentleftpanel-module/ContentLeftPanel", "./CroppedImageDimensions", "./DownloadDialogue", "./Events", "../../modules/uv-dialogues-module/ExternalContentDialogue", "../../modules/uv-osdmobilefooterpanel-module/MobileFooter", "../../modules/uv-searchfooterpanel-module/FooterPanel", "../../modules/uv-dialogues-module/HelpDialogue", "./Mode", "../../modules/uv-dialogues-module/MoreInfoDialogue", "../../modules/uv-moreinforightpanel-module/MoreInfoRightPanel", "../../modules/uv-multiselectdialogue-module/MultiSelectDialogue", "./MultiSelectionArgs", "../../modules/uv-pagingheaderpanel-module/PagingHeaderPanel", "../../modules/uv-shared-module/Point", "../../modules/uv-seadragoncenterpanel-module/SeadragonCenterPanel", "./SettingsDialogue", "./ShareDialogue", "../../modules/uv-shared-module/Shell"], function (e, t, n, i, o, r, s, a, u, l, c, h, p, d, f, g, v, m, y, E, b, _, w, S, x) {
    ...
    var I = Manifold.AnnotationGroup, T = function (e) {
        ...
        return __extends(t, e), t.prototype.create = function () {
            var t = this;
            e.prototype.create.call(this), $.subscribe(i.BaseEvents.METRIC_CHANGED, function () {
                if (t.isDesktopMetric()) x.Shell.$rightPanel.show(); else {
                    var e = {};
                    e.pagingEnabled = !1, t.updateSettings(e), $.publish(i.BaseEvents.UPDATE_SETTINGS), x.Shell.$rightPanel.hide()
                }
                ...
                t.clearAnnotations(), $.publish(i.BaseEvents.ANNOTATIONS_CLEARED), t.fire(i.BaseEvents.CLEAR_ANNOTATIONS)
                ...
                t.fire(i.BaseEvents.FIRST), $.publish(i.BaseEvents.CANVAS_INDEX_CHANGED, [t.helper.getFirstPageIndex()])
                ...
                t.fire(i.BaseEvents.LAST), $.publish(i.BaseEvents.CANVAS_INDEX_CHANGED, [t.helper.getLastPageIndex()])
            }), $.subscribe(i.BaseEvents.LEFT_ARROW, function () {
                t.useArrowKeysToNavigate() ? $.publish(i.BaseEvents.CANVAS_INDEX_CHANGED, [t.getPrevPageIndex()]) : t.centerPanel.setFocus()
            }), $.subscribe(i.BaseEvents.LEFTPANEL_COLLAPSE_FULL_START, function () {
                ...
                o.manifestUri = t.helper.iiifResourceUri, o.allCanvases = n.length === t.helper.getCanvases().length, o.canvases = n, o.format = t.data.config.options.multiSelectionMimeType, o.sequence = t.helper.getCurrentSequence().id, t.fire(i.BaseEvents.MULTISELECTION_MADE, o)
            }), $.subscribe(i.BaseEvents.NEXT, function () {
                t.fire(i.BaseEvents.NEXT), $.publish(i.BaseEvents.CANVAS_INDEX_CHANGED, [t.getNextPageIndex()])
                ...
                t.fire(i.BaseEvents.PREV), $.publish(i.BaseEvents.CANVAS_INDEX_CHANGED, [t.getPrevPageIndex()])
                ...
                t.useArrowKeysToNavigate() ? $.publish(i.BaseEvents.CANVAS_INDEX_CHANGED, [t.getNextPageIndex()]) : t.centerPanel.setFocus()
                ...
                t.centerPanel && i && ($.publish(l.Events.XYWH_CHANGED, [i.toString()]), t.data.xywh = i.toString(), t.fire(l.Events.XYWH_CHANGED, t.data.xywh));
                ...
                t.data.rotation = n, t.fire(l.Events.SEADRAGON_ROTATION, t.data.rotation), t.currentRotation = n
            ...
            o.terms = t, o.annotations = this.annotations, $.publish(i.BaseEvents.ANNOTATIONS, [o])
            ...
            var t = this.helper.getRangeByPath(e);
            if (t) {
                var n = t.getCanvasIds()[0], o = this.helper.getCanvasIndexById(n);
                $.publish(i.BaseEvents.CANVAS_INDEX_CHANGED, [o])
            }
        }, t.prototype.viewLabel = function (e) {
            if (!e) return this.showMessage(this.data.config.modules.genericDialogue.content.emptyValue), void $.publish(i.BaseEvents.CANVAS_INDEX_CHANGE_FAILED);
            var t = this.helper.getCanvasIndexByLabel(e);
            -1 != t ? $.publish(i.BaseEvents.CANVAS_INDEX_CHANGED, [t]) : (this.showMessage(this.data.config.modules.genericDialogue.content.pageNotFound), $.publish(i.BaseEvents.CANVAS_INDEX_CHANGE_FAILED))
        }, t.prototype.treeNodeSelected = function (e) {
            var t = e.data;
            if (t.type) switch (t.type) {
                case manifesto.IIIFResourceType.manifest().toString():
            ...
            this.annotations = null, $.publish(i.BaseEvents.CANVAS_INDEX_CHANGED, [this.helper.canvasIndex])
        }, t.prototype.prevSearchResult = function () {
            var e;
            if (this.annotations) for (var t = this.annotations.length - 1; t >= 0; t--) {
            ...
            if (this.annotations) for (var e = 0; e < this.annotations.length; e++) {
            ...
            e.prototype.bookmark.call(this);
            var t = this.helper.getCurrentCanvas(), n = new r.Bookmark;
            ...
            var n = t.viewport.getBounds(!0), i = new a.CroppedImageDimensions, o = Math.floor(n.width),
                r = Math.floor(n.height), s = Math.floor(n.x), u = Math.floor(n.y);
            ...
            var l = o, c = r, h = e.getMaxDimensions();
            if (h) {
                if (o > h.width) {
                    var p = h.width;
            ...
            return i.region = new manifesto.Size(l, c), i.regionPos = new b.Point(s, u), i.size = new manifesto.Size(o, r), i
        }, t.prototype.getCroppedImageUri = function (e, t) {
            if (!t) return null;
            if (!t.viewport) return null;
            var n = this.getCroppedImageDimensions(e, t);
            if (!n) return null;
            var i = this.getImageBaseUri(e), o = this.getImageId(e);
            if (!o) return null;
            var r = n.regionPos.x + "," + n.regionPos.y + "," + n.region.width + "," + n.region.height,
                s = n.size.width + "," + n.size.height, a = this.getViewerRotation(), u = "default";
            return i + "/" + o + "/" + r + "/" + s + "/" + a + "/" + u + ".jpg"
        }, t.prototype.getConfinedImageDimensions = function (e, t) {
            var n = new manifesto.Size(0, 0);
            n.width = t; // set through configuration options. 1000
            var maxWidth = e.externalResource.data.width;
            var i = Utils.Maths.normalise(t, 0, maxWidth); // ratio to normalize image. maxWidth used to be e.getWidth()
            var maxHeight = e.externalResource.data.height;
            console.log(n);
            return n.height = Math.floor(maxHeight * i), n //e.getHeight()
            return n.height
        }, t.prototype.getConfinedImageUri = function (e, t) {
            var n = this.getImageBaseUri(e), i = this.getImageId(e);
            if (!i) return null;
            var o = "full", r = this.getConfinedImageDimensions(e, t), s = r.width + "," + r.height, //  r object returned by getConfinedImageDimensions() above
                a = this.getViewerRotation(), u = "default";
            ...
            var t = null, n = e.getImages();
            if (n && n.length) for (var i = n[0], o = i.getResource(), r = o.getServices(), s = 0; s < r.length; s++) {
                var a = r[s], u = a.id;
            ...
            var r = this.data.config.uri || "", s = this.getSerializedLocales(), a = this.getAppUri(),
                u = a + "#?manifest=" + this.helper.iiifResourceUri + "&c=" + this.helper.collectionIndex + "&m=" + this.helper.manifestIndex + "&s=" + this.helper.sequenceIndex + "&cv=" + this.helper.canvasIndex + "&config=" + r + "&locales=" + s + "&xywh=" + i + "&r=" + o,
            ...
            if (!this.isAnnotating) {
                ...
                var t = this, n = this.getSearchServiceUri();
                n && (n = Utils.Strings.format(n, encodeURIComponent(e)), this.getSearchResults(n, e, this.annotations, function (n) {
                    t.isAnnotating = !1, n.length ? t.annotate(n, e) : t.showMessage(t.data.config.modules.genericDialogue.content.noMatches, function () {
            ...
            for (var t = [], n = function (n) {
                var o = e.resources[n], r = i.helper.getCanvasIndexById(o.on.match(/(.*)#/)[1]), s = new I(o, r),
    ...
    var r = function (e) {
        ...
        return __extends(t, e), t.prototype.create = function () {
            ...
            this.setConfig("pdfCenterPanel"), e.prototype.create.call(this), this._$pdfContainer = $('<div class="pdfContainer"></div>'), this._$canvas = $("<canvas></canvas>"), this._$spinner = $('<div class="spinner"></div>'), this._canvas = this._$canvas[0], this._ctx = this._canvas.getContext("2d"), this.$content.append(this._$spinner), this._$prevButton = $('<div class="btn prev" tabindex="0"></div>'), this.$content.append(this._$prevButton), this._$nextButton = $('<div class="btn next" tabindex="0"></div>'), this.$content.append(this._$nextButton), this._$zoomInButton = $('<div class="btn zoomIn" tabindex="0"></div>'), this.$content.append(this._$zoomInButton), this._$zoomOutButton = $('<div class="btn zoomOut" tabindex="0"></div>'), this.$content.append(this._$zoomOutButton), this._$pdfContainer.append(this._$canvas), this.$content.prepend(this._$pdfContainer), $.subscribe(n.BaseEvents.OPEN_EXTERNAL_RESOURCE, function (e, n) {
                ...
                t._pdfDoc && (1 > n || n > t._pdfDoc.numPages || (t._pageIndex = n, t._queueRenderPage(t._pageIndex)))
            ...
            this._$spinner.show(), this.extension.getExternalResources(e).then(function () {
                var e = null, n = t.extension.helper.getCurrentCanvas(), i = t.extension.getMediaFormats(n), r = n.id;
                e = i && i.length ? i[0].id : n.id, t.config.options.usePdfJs ? (PDFJS.disableWorker = !0, PDFJS.getDocument(e).then(function (e) {
                    t._pdfDoc = e, t._render(t._pageIndex), $.publish(o.Events.PDF_LOADED, [e]), t._$spinner.hide()
                })) : window.PDFObject.embed(r, "#content", {id: "PDF"})
            })
        }, t.prototype._render = function (e) {
            var t = this;
            this._pageRendering = !0, this._$zoomOutButton.enable(), this._$zoomInButton.enable();
            var n = this._scale - .5, i = this._scale + .5;
            n < this._minScale && this._$zoomOutButton.disable(), i > this._maxScale && this._$zoomInButton.disable(), this._pdfDoc.getPage(e).then(function (e) {
                ...
                t._renderTask = e.render(n), t._renderTask.promise.then(function () {
                    $.publish(o.Events.PAGE_INDEX_CHANGED, [t._pageIndex]), t._pageRendering = !1, null !== t._pageIndexPending && (t._render(t._pageIndexPending), t._pageIndexPending = null), 1 === t._pageIndex ? t.disablePrevButton() : t.enablePrevButton(), t._pageIndex === t._pdfDoc.numPages ? t.disableNextButton() : t.enableNextButton()
                })["catch"](function (e) {
                })
            })
...
define("modules/uv-pdfheaderpanel-module/PDFHeaderPanel", ["require", "exports", "../uv-shared-module/BaseEvents", "../../extensions/uv-pdf-extension/Events", "../uv-shared-module/HeaderPanel"], function (e, t, n, i, o) {
    ...
    var r = function (e) {
        ...
        return __extends(t, e), t.prototype.create = function () {
            var t = this;
            this.setConfig("pdfHeaderPanel"), e.prototype.create.call(this), $.subscribe(i.Events.PAGE_INDEX_CHANGED, function (e, n) {
            ...
            return isNaN(t) ? void this.extension.showMessage(this.extension.data.config.modules.genericDialogue.content.invalidNumber) : void $.publish(i.Events.SEARCH, [t])
        }, t.prototype.resize = function () {
            e.prototype.resize.call(this)
        }, t
    }(o.HeaderPanel);
...
define("extensions/uv-pdf-extension/Extension", ["require", "exports", "../../modules/uv-shared-module/BaseEvents", "../../modules/uv-shared-module/BaseExtension", "../../modules/uv-shared-module/Bookmark", "./DownloadDialogue", "../../modules/uv-shared-module/FooterPanel", "../../modules/uv-moreinforightpanel-module/MoreInfoRightPanel", "../../modules/uv-pdfcenterpanel-module/PDFCenterPanel", "../../modules/uv-pdfheaderpanel-module/PDFHeaderPanel", "../../modules/uv-resourcesleftpanel-module/ResourcesLeftPanel", "./SettingsDialogue", "./ShareDialogue", "../../modules/uv-shared-module/Shell"], function (e, t, n, i, o, r, s, a, u, l, c, h, p, d) {
    ...
    var f = function (e) {
        ...
        return __extends(t, e), t.prototype.create = function () {
            var t = this;
            requirejs.config({paths: {"pdfjs-dist/build/pdf.combined": this.data.root + "/lib/pdf.combined"}}), e.prototype.create.call(this), $.subscribe(n.BaseEvents.CANVAS_INDEX_CHANGED, function (e, n) {
                t.viewCanvas(n)
            }), $.subscribe(n.BaseEvents.THUMB_SELECTED, function (e, t) {
                $.publish(n.BaseEvents.CANVAS_INDEX_CHANGED, [t.index])
            }), $.subscribe(n.BaseEvents.LEFTPANEL_EXPAND_FULL_START, function () {
...
define("modules/uv-virtexcenterpanel-module/VirtexCenterPanel", ["require", "exports", "../uv-shared-module/BaseEvents", "../uv-shared-module/CenterPanel", "../../Utils"], function (e, t, n, i, o) {
    ...
    var r = function (e) {
        ...
        return __extends(t, e), t.prototype.create = function () {
            ...
            this.extension.getExternalResources(e).then(function () {
                t.$viewport.empty();
                var e = null, n = t.extension.helper.getCurrentCanvas(), i = t.extension.getMediaFormats(n), o = null,
                ...
                t.viewport = new Virtex.Viewport({
                    target: t.$viewport[0],
                    data: {antialias: !s, file: e, fullscreenEnabled: !1, type: r, showStats: t.options.showStats}
...
define("UVComponent", ["require", "exports", "./modules/uv-shared-module/BaseEvents", "./extensions/uv-av-extension/Extension", "./extensions/uv-default-extension/Extension", "./extensions/uv-mediaelement-extension/Extension", "./extensions/uv-seadragon-extension/Extension", "./extensions/uv-pdf-extension/Extension", "./extensions/uv-virtex-extension/Extension", "./Utils"], function (e, t, n, i, o, r, s, a, u, l) {
    "use strict";
    Object.defineProperty(t, "__esModule", {value: !0});
    var c = function (e) {
        function t(t) {
        ...
        return __extends(t, e), t.prototype._init = function () {
            ...
            var t = this;
            $.disposePubSub(), $.subscribe(n.BaseEvents.RELOAD, function (e, i) {
            ...
            Manifold.loadManifest({
                ...
                var s = void 0, a = r.getContent();
                if (a.length) {
                    var u = a[0], l = u.getBody();
                    if (l && l.length) {
                        var c = l[0].getFormat();
                        if (c) {
            ...
            if (e.locales) {
                var i = sessionStorage.getItem(t.name + "." + e.locales[0].name), o = e.configUri;
                if (i) n(JSON.parse(i)); else if (o) if (this._isCORSEnabled()) $.getJSON(o, function (e) {
                    n(e)
                }); else {
                    var r = {
                        url: o,
            ...
            if (e.locales) {
                var i = e.root + "/themes/" + e.config.options.theme + "/css/" + t.name + "/theme.css",
                    o = e.locales[0].name, r = t.name.toLowerCase() + "-theme-" + o.toLowerCase(),
                    s = $("#" + r.toLowerCase());
...
}(), requirejs(["./lib/base64.min.js", "./lib/browserdetect.js", "./lib/detectmobilebrowser.js", "./lib/jquery.xdomainrequest.js", "./lib/modernizr.js", "./lib/ex.es3.min.js", "./lib/BaseComponent.js", "./lib/KeyCodes.js", "./lib/HTTPStatusCode.js", "./lib/jquery-plugins.js", "./lib/ba-tiny-pubsub.js", "./lib/manifesto.js", "./lib/manifold.js", "./lib/Utils.js", "./lib/xss.min.js", "URLDataProvider", "UVComponent"], function (e, t, n, i, o, r, s, a, u, l, c, h, p, d, f, g, v) {
    window.UV = v["default"], window.UV.URLDataProvider = g["default"], window.dispatchEvent(new CustomEvent("uvLoaded", {}))
}), define("app", function () {
});