...
RSpec.describe Hyrax::Dashboard::NestCollectionsController do
  ...
  describe 'POST #create_relationship_within' do
    ...
    context 'when save succeeds' do
      ...
      it 'authorizes, flashes a notice, and redirects' do
        expect { post 'create_relationship_within', params: parameters }.to have_enqueued_job(ReindexNestedMembersJob)
  ...
  describe 'GET #create_collection_under' do
    ...
    describe 'when validation succeeds' do
      ...
      it 'authorizes, flashes a notice, and redirects' do
        expect { get 'create_collection_under', params: parameters }.to have_enqueued_job(ReindexNestedMembersJob)
  ...
  describe 'POST #create_relationship_under' do
    ...
    describe 'when save succeeds' do
      ...
      it 'authorizes, flashes a notice, and redirects' do
        expect { post 'create_relationship_under', params: parameters }.to have_enqueued_job(ReindexNestedMembersJob)
  ...
  describe 'POST #remove_relationship_above' do
    ...
    describe 'when remove succeeds' do
      ...
      it 'authorizes, flashes a notice, and redirects' do
        expect { post 'remove_relationship_above', params: parameters }.to have_enqueued_job(ReindexNestedMembersJob)
  ...
  describe 'POST #remove_relationship_under' do
    ...
    describe 'when remove succeeds' do
      ...
      it 'authorizes, flashes a notice, and redirects' do
        expect { post 'remove_relationship_under', params: parameters }.to have_enqueued_job(ReindexNestedMembersJob)
