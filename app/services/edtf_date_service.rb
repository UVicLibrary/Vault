class EdtfDateService
  ...
  def parse_date(date_string)
    ...
    if date_string == "unknown" or date_string == "no date"
      date_string
    elsif season_interval?(date_string) or century_or_decade_interval?(date_string)
      # edtf can't normally parse season, century, or decade intervals,
      # so we create an interval using the first season's first date
      # and the last season's last date
