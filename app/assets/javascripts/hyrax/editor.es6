// Override Hyrax 4.0 to replace ControlledVocabulary with our own
// custom class, MixedControlledVocabulary, which allows both strings
// and URIs.
...
import MixedControlledVocabulary from './editor/mixed_controlled_vocabulary'
