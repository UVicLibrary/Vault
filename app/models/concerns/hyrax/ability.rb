module Hyrax
  module Ability
    ...
    included do
      ...
      self.registered_group_name = 'uvic' # We're changing this to match permissions created from CAS authentication
    ...
    def extract_subjects(subject)
      case subject
      when Hyrax::WorkShowPresenter, FileSetPresenter, Hyrax::CollectionPresenter, VaultCollectionPresenter
