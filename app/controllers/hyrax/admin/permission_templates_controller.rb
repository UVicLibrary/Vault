    ...
    class PermissionTemplatesController < ApplicationController
      ...
      def update
        ...
        if update_info[:updated] == true # Ensure we redirect to currently active tab with the appropriate notice
          ...
          redirect_to("/dashboard/collections/#{params[:collection_id]}/confirm")
        else
      ...
      def current_tab
        ...
        if collection?
          access_attributes = pt[:access_grants_attributes]
          if access_attributes and access_attributes['0'] and access_attributes['0']['access'] == "view"
