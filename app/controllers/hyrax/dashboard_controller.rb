...
module Hyrax
  class DashboardController < ApplicationController
    ...
    self.sidebar_partials = { activity: [], configuration: [], repository_content: [], tasks: ["hyrax/dashboard/sidebar/batch_processing", "hyrax/dashboard/sidebar/replace_or_delete_fast_uris", "hyrax/dashboard/sidebar/review_transfers"] }
