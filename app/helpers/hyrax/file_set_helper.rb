module Hyrax::FileSetHelper
  ...
  # If false, public users can still view but not download the file set.
  # Removing public users from the downloads group doesn't work because
  # they need that permission to view files and thumbnails.
  def allow_downloads?(file_set)
