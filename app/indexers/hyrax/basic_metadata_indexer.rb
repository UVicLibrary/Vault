module Hyrax
  ...
  class BasicMetadataIndexer < ActiveFedora::RDF::IndexingService
    ...
    self.stored_and_facetable_fields = %i[resource_type creator contributor keyword publisher subject language based_near provider physical_repository geographic_coverage genre date_created year]
    self.stored_fields = %i[description license rights_statement identifier related_url bibliographic_citation source]
